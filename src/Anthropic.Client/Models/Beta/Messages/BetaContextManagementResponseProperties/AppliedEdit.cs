...
namespace Anthropic.Client.Models.Beta.Messages.BetaContextManagementResponseProperties;
...
public record class AppliedEdit
{
    ...
    public void Switch(
        Action<BetaClearToolUses20250919EditResponse> betaClearToolUses20250919EditResponse,
        Action<BetaClearThinking20251015EditResponse> betaClearThinking20251015EditResponse
    )
    {
        switch (this.Value)
        {
    ...
    public T Match<T>(
        Func<BetaClearToolUses20250919EditResponse, T> betaClearToolUses20250919EditResponse,
        Func<BetaClearThinking20251015EditResponse, T> betaClearThinking20251015EditResponse
    )
    {
