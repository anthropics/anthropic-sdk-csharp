...
public record class Content
{
    ...
    public Content(List<BetaContentBlockSourceContent> value)
    {
        Value = value;
    }
    ...
    public void Switch(
        ...
        Action<List<BetaContentBlockSourceContent>> betaContentBlockSourceContent
    )
    {
        switch (this.Value)
        {
    ...
    public T Match<T>(
        ...
        Func<List<BetaContentBlockSourceContent>, T> betaContentBlockSourceContent
    )
    {
