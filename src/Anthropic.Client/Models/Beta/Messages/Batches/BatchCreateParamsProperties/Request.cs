...
using Anthropic.Client.Models.Beta.Messages.Batches.BatchCreateParamsProperties.RequestProperties;

namespace Anthropic.Client.Models.Beta.Messages.Batches.BatchCreateParamsProperties;
