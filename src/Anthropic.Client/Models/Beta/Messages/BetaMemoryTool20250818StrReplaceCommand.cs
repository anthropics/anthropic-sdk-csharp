    ...
    public required string NewStr
    {
        get
        {
            if (!this.Properties.TryGetValue("new_str", out JsonElement element))
                throw new ArgumentOutOfRangeException("new_str", "Missing required argument");

            return JsonSerializer.Deserialize<string>(element, ModelBase.SerializerOptions)
                ?? throw new ArgumentNullException("new_str");
        }
        set
        {
    ...
    public required string OldStr
    {
        get
        {
            if (!this.Properties.TryGetValue("old_str", out JsonElement element))
                throw new ArgumentOutOfRangeException("old_str", "Missing required argument");

            return JsonSerializer.Deserialize<string>(element, ModelBase.SerializerOptions)
                ?? throw new ArgumentNullException("old_str");
        }
        set
        {
