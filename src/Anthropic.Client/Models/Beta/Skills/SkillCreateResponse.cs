...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    SkillCreateResponse(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static SkillCreateResponse FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
