...
public record class TextCitationParam : ModelBase
{
    ...
    public string CitedText
    {
        get
        {
            ...
            {
                CitationCharLocationParam x => x.CitedText,
                CitationPageLocationParam x => x.CitedText,
                CitationContentBlockLocationParam x => x.CitedText,
                CitationWebSearchResultLocationParam x => x.CitedText,
                CitationSearchResultLocationParam x => x.CitedText,
    ...
    public long? DocumentIndex
    {
        get
        {
            return this.Value switch
            {
                CitationCharLocationParam x => x.DocumentIndex,
                CitationPageLocationParam x => x.DocumentIndex,
                CitationContentBlockLocationParam x => x.DocumentIndex,
                CitationWebSearchResultLocationParam _ => null,
                CitationSearchResultLocationParam _ => null,
    ...
    public string? DocumentTitle
    {
        get
        {
            return this.Value switch
            {
                CitationCharLocationParam x => x.DocumentTitle,
                CitationPageLocationParam x => x.DocumentTitle,
                CitationContentBlockLocationParam x => x.DocumentTitle,
                CitationWebSearchResultLocationParam _ => null,
                CitationSearchResultLocationParam _ => null,
    ...
    public JsonElement Type
    {
        get
        {
            return this.Value switch
            {
                CitationCharLocationParam x => x.Type,
                CitationPageLocationParam x => x.Type,
                CitationContentBlockLocationParam x => x.Type,
                CitationWebSearchResultLocationParam x => x.Type,
                CitationSearchResultLocationParam x => x.Type,
    ...
    public long? EndBlockIndex
    {
        get
        {
            return this.Value switch
            {
                CitationCharLocationParam _ => null,
                CitationPageLocationParam _ => null,
                CitationContentBlockLocationParam x => x.EndBlockIndex,
                CitationWebSearchResultLocationParam _ => null,
                CitationSearchResultLocationParam x => x.EndBlockIndex,
                _ => WrappedJsonSerializer.GetNullableStructProperty<long>(
                    this.Json,
                    "end_block_index"
                ),
    ...
    public long? StartBlockIndex
    {
        get
        {
            return this.Value switch
            {
                CitationCharLocationParam _ => null,
                CitationPageLocationParam _ => null,
                CitationContentBlockLocationParam x => x.StartBlockIndex,
                CitationWebSearchResultLocationParam _ => null,
                CitationSearchResultLocationParam x => x.StartBlockIndex,
                _ => WrappedJsonSerializer.GetNullableStructProperty<long>(
                    this.Json,
                    "start_block_index"
                ),
    ...
    public string? Title
    {
        get
        {
            return this.Value switch
            {
                CitationCharLocationParam _ => null,
                CitationPageLocationParam _ => null,
                CitationContentBlockLocationParam _ => null,
                CitationWebSearchResultLocationParam x => x.Title,
                CitationSearchResultLocationParam x => x.Title,
