...
public record class WebSearchToolResultBlockParamCaller : ModelBase
{
    ...
    public WebSearchToolResultBlockParamCaller(
        WebSearchToolResultBlockParamCallerCodeExecution20260120 value,
    ...
    /// <summary>
    /// Returns true and sets the <c>out</c> parameter if the instance was constructed with a variant of
    /// type <see cref="WebSearchToolResultBlockParamCallerCodeExecution20260120"/>.
    ///
    /// <para>Consider using <see cref="Switch"> or <see cref="Match"> if you need to handle every variant.</para>
    ///
    /// <example>
    ...
    ///     // `value` is of type `WebSearchToolResultBlockParamCallerCodeExecution20260120`
    ///     Console.WriteLine(value);
    /// }
    /// </code>
    /// </example>
    ...
    public bool TryPickCodeExecution20260120(
        [NotNullWhen(true)] out WebSearchToolResultBlockParamCallerCodeExecution20260120? value
    )
    {
        value = this.Value as WebSearchToolResultBlockParamCallerCodeExecution20260120;
        return value != null;
    }
    ...
    public void Switch(
        ...
        System::Action<WebSearchToolResultBlockParamCallerCodeExecution20260120> codeExecution20260120
    )
    {
        switch (this.Value)
        {
            ...
            case ServerToolCaller value:
                serverTool(value);
                break;
            case WebSearchToolResultBlockParamCallerCodeExecution20260120 value:
    ...
    public T Match<T>(
        ...
        System::Func<
            WebSearchToolResultBlockParamCallerCodeExecution20260120,
            T
    ...
    )
    {
        return this.Value switch
        {
            ...
            WebSearchToolResultBlockParamCallerCodeExecution20260120 value => codeExecution20260120(
                value
            ),
    ...
    int VariantIndex()
    {
        return this.Value switch
        {
            ...
            WebSearchToolResultBlockParamCallerCodeExecution20260120 _ => 2,
            _ => -1,
        };
    }
}
...
[JsonConverter(
    typeof(JsonModelConverter<
        WebSearchToolResultBlockParamCallerCodeExecution20260120,
        WebSearchToolResultBlockParamCallerCodeExecution20260120FromRaw
    >)
)]
public sealed record class WebSearchToolResultBlockParamCallerCodeExecution20260120 : JsonModel
{
    ...
    public WebSearchToolResultBlockParamCallerCodeExecution20260120()
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public WebSearchToolResultBlockParamCallerCodeExecution20260120(
        WebSearchToolResultBlockParamCallerCodeExecution20260120 webSearchToolResultBlockParamCallerCodeExecution20260120
    )
        : base(webSearchToolResultBlockParamCallerCodeExecution20260120) { }
#pragma warning restore CS8618
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="WebSearchToolResultBlockParamCallerCodeExecution20260120FromRaw.FromRawUnchecked"/>
    public static WebSearchToolResultBlockParamCallerCodeExecution20260120 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    ...
    [SetsRequiredMembers]
    public WebSearchToolResultBlockParamCallerCodeExecution20260120(string toolID)
        : this()
    {
        this.ToolID = toolID;
    }
...
class WebSearchToolResultBlockParamCallerCodeExecution20260120FromRaw
    : IFromRawJson<WebSearchToolResultBlockParamCallerCodeExecution20260120>
{
    /// <inheritdoc/>
    public WebSearchToolResultBlockParamCallerCodeExecution20260120 FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => WebSearchToolResultBlockParamCallerCodeExecution20260120.FromRawUnchecked(rawData);
}
