...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<ImageTransformationsParam, ImageTransformationsParamFromRaw>)
)]
public sealed record class ImageTransformationsParam : JsonModel
{
    /// <summary>
    ...
    public ImageTransformationsParam() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ImageTransformationsParam(ImageTransformationsParam imageTransformationsParam)
        : base(imageTransformationsParam) { }
#pragma warning restore CS8618

    public ImageTransformationsParam(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ImageTransformationsParam(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ImageTransformationsParamFromRaw.FromRawUnchecked"/>
    public static ImageTransformationsParam FromRawUnchecked(
...
class ImageTransformationsParamFromRaw : IFromRawJson<ImageTransformationsParam>
{
    /// <inheritdoc/>
    public ImageTransformationsParam FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ImageTransformationsParam.FromRawUnchecked(rawData);
}
