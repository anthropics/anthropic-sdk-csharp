...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<BrowserStateTabEntry, BrowserStateTabEntryFromRaw>))]
public sealed record class BrowserStateTabEntry : JsonModel
{
    /// <summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BrowserStateTabEntry(BrowserStateTabEntry browserStateTabEntry)
        : base(browserStateTabEntry) { }
#pragma warning restore CS8618

    public BrowserStateTabEntry(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BrowserStateTabEntry(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BrowserStateTabEntryFromRaw.FromRawUnchecked"/>
    public static BrowserStateTabEntry FromRawUnchecked(
...
class BrowserStateTabEntryFromRaw : IFromRawJson<BrowserStateTabEntry>
{
    /// <inheritdoc/>
    public BrowserStateTabEntry FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BrowserStateTabEntry.FromRawUnchecked(rawData);
}
