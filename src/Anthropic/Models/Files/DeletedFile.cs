...
public sealed record class DeletedFile : JsonModel
{
    ...
    /// </summary>
    public ApiEnum<string, global::Anthropic.Models.Files.Type>? Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                ApiEnum<string, global::Anthropic.Models.Files.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::Anthropic.Models.Files.Type>
{
    public override global::Anthropic.Models.Files.Type Read(
    ...
    )
    {
        ...
        {
            "file_deleted" => global::Anthropic.Models.Files.Type.FileDeleted,
            _ => (global::Anthropic.Models.Files.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Anthropic.Models.Files.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Anthropic.Models.Files.Type.FileDeleted => "file_deleted",
