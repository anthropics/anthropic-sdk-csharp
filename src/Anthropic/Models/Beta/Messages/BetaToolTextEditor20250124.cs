        ...
        Anthropic::IFromRaw<BetaToolTextEditor20250124>
{
    ...
    public override void Validate()
    {
        if (
            !this.Name.Equals(
                Json::JsonSerializer.Deserialize<Json::JsonElement>("\"str_replace_editor\"")
            )
        )
        {
        ...
        if (
            !this.Type.Equals(
                Json::JsonSerializer.Deserialize<Json::JsonElement>("\"text_editor_20250124\"")
            )
        )
        {
            throw new System::Exception();
    ...
    {
        this.Name = Json::JsonSerializer.Deserialize<Json::JsonElement>("\"str_replace_editor\"");
        this.Type = Json::JsonSerializer.Deserialize<Json::JsonElement>("\"text_editor_20250124\"");
    }
