...
public sealed record class BetaMessageBatch : ModelBase, IFromRaw<BetaMessageBatch>
{
    ...
    public required BetaMessageBatchProperties::ProcessingStatus ProcessingStatus
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BetaMessageBatchProperties::ProcessingStatus>(element)
    ...
    public required BetaMessageBatchRequestCounts RequestCounts
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BetaMessageBatchRequestCounts>(element)
