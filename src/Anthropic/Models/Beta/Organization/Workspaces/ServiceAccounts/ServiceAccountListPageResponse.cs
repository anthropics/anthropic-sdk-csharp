...
{
    public required IReadOnlyList<ServiceAccounts::BetaServiceAccountWorkspaceMember> Data
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<
                ImmutableArray<ServiceAccounts::BetaServiceAccountWorkspaceMember>
            >("data");
        }
        init
        {
            this._rawData.Set<ImmutableArray<ServiceAccounts::BetaServiceAccountWorkspaceMember>>(
                "data",
