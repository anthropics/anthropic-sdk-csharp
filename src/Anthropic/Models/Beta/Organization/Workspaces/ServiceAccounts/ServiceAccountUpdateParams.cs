...
///
/// <para>The new `workspace_role` replaces the current one. Only explicit memberships
/// can be updated; to set a role on the implicit default-workspace membership, add
/// the service account explicitly with `POST /workspaces/{workspace_id}/service_accounts`.
/// Archived workspaces return 400. Archived service accounts cannot be updated and
/// are rejected.</para>
///
...
#pragma warning disable CS8618
    ...
    {
        this.WorkspaceID = serviceAccountUpdateParams.WorkspaceID;
