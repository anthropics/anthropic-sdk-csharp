...
[JsonConverter(typeof(BetaComplianceSettingsStateParamConverter))]
public record class BetaComplianceSettingsStateParam : ModelBase
{
    ...
    public BetaComplianceSettingsStateParam(
    ...
    public BetaComplianceSettingsStateParam(JsonElement element)
    {
        this._element = element;
    }
    ...
    /// </summary>
    public void Switch(
        Action<BetaComplianceSettingsStateEnabledParam> enabled,
        Action<BetaComplianceSettingsStateDisabledParam> disabled
    )
    {
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaComplianceSettingsStateParam"
                );
        }
    }
    ...
    /// </summary>
    public T Match<T>(
        Func<BetaComplianceSettingsStateEnabledParam, T> enabled,
        Func<BetaComplianceSettingsStateDisabledParam, T> disabled
    )
    {
        return this.Value switch
        {
            BetaComplianceSettingsStateEnabledParam value => enabled(value),
            BetaComplianceSettingsStateDisabledParam value => disabled(value),
    ...
    public static implicit operator BetaComplianceSettingsStateParam(
        BetaComplianceSettingsStateEnabledParam value
    ) => new(value);
    ...
    public virtual bool Equals(BetaComplianceSettingsStateParam? other) =>
        other != null
...
sealed class BetaComplianceSettingsStateParamConverter
    : JsonConverter<BetaComplianceSettingsStateParam>
{
    public override BetaComplianceSettingsStateParam? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaComplianceSettingsStateParam(element);
            }
        }
    }
    ...
    public override void Write(
        ...
        BetaComplianceSettingsStateParam value,
        JsonSerializerOptions options
    )
    {
