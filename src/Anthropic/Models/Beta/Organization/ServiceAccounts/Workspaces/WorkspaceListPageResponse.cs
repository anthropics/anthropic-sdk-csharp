...
{
    public required IReadOnlyList<BetaServiceAccountWorkspaceMember> Data
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<
                ImmutableArray<BetaServiceAccountWorkspaceMember>
            >("data");
        }
        init
        {
            this._rawData.Set<ImmutableArray<BetaServiceAccountWorkspaceMember>>(
                "data",
