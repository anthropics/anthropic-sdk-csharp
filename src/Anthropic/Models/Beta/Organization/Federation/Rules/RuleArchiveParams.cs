...
///
/// <para>Token exchange through this rule stops immediately. Idempotent; re-archiving
...
/// only manage rules whose `oauth_scope` is `workspace:developer` or `workspace:inference`;
...
/// </summary>
public record class RuleArchiveParams : ParamsBase
{
    ...
    public RuleArchiveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public RuleArchiveParams(RuleArchiveParams ruleArchiveParams)
        : base(ruleArchiveParams)
    {
        this.FederationRuleID = ruleArchiveParams.FederationRuleID;
    }
...
#pragma warning restore CS8618
    ...
    public static RuleArchiveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string federationRuleID
    )
    ...
    public virtual bool Equals(RuleArchiveParams? other)
    {
        if (other == null)
        {
            return false;
