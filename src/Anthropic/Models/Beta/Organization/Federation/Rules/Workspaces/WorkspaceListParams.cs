...
/// `page` parameters are accepted but have no effect, and `next_page` is always `null`.
/// Returns explicit per-workspace enablements only; for rules with `applies_to_all_workspaces`
/// or a legacy single `workspace_id`, check those fields on the rule itself.</para>
///
...
#pragma warning disable CS8618
    ...
    {
        this.FederationRuleID = workspaceListParams.FederationRuleID;
    }
