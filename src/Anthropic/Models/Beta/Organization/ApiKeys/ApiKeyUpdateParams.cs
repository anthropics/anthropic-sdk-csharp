...
/// </summary>
public record class ApiKeyUpdateParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ApiKeyUpdateParams(ApiKeyUpdateParams apiKeyUpdateParams)
        : base(apiKeyUpdateParams)
    {
        this.ApiKeyID = apiKeyUpdateParams.ApiKeyID;

        this._rawBodyData = new(apiKeyUpdateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static ApiKeyUpdateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string apiKeyID
    ...
    public virtual bool Equals(ApiKeyUpdateParams? other)
    {
        if (other == null)
        {
            return false;
