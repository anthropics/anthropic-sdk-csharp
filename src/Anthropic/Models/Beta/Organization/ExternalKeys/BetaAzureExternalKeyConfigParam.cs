...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaAzureExternalKeyConfigParamFromRaw
    >)
)]
public sealed record class BetaAzureExternalKeyConfigParam : JsonModel
{
    /// <summary>
    ...
    public BetaAzureExternalKeyConfigParam()
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BetaAzureExternalKeyConfigParam(
        BetaAzureExternalKeyConfigParam betaAzureExternalKeyConfigParam
    )
        : base(betaAzureExternalKeyConfigParam) { }
#pragma warning restore CS8618

    public BetaAzureExternalKeyConfigParam(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaAzureExternalKeyConfigParam(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaAzureExternalKeyConfigParamFromRaw.FromRawUnchecked"/>
    public static BetaAzureExternalKeyConfigParam FromRawUnchecked(
...
class BetaAzureExternalKeyConfigParamFromRaw : IFromRawJson<BetaAzureExternalKeyConfigParam>
{
    /// <inheritdoc/>
    public BetaAzureExternalKeyConfigParam FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaAzureExternalKeyConfigParam.FromRawUnchecked(rawData);
}
