...
/// </summary>
public record class ExternalKeyDeleteParams : ParamsBase
{
    public string? ExternalKeyID { get; init; }

    public ExternalKeyDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExternalKeyDeleteParams(ExternalKeyDeleteParams externalKeyDeleteParams)
        : base(externalKeyDeleteParams)
    {
        this.ExternalKeyID = externalKeyDeleteParams.ExternalKeyID;
    }
...
#pragma warning restore CS8618
    ...
    public static ExternalKeyDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string externalKeyID
    )
    ...
    public virtual bool Equals(ExternalKeyDeleteParams? other)
    {
        if (other == null)
        {
            return false;
