...
/// </summary>
public record class ExternalKeyCreateParams : ParamsBase
{
    ...
    /// </summary>
    public required ProviderConfig ProviderConfig
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<ProviderConfig>("provider_config");
        }
    ...
    /// </summary>
    public ApiEnum<string, Geo>? Geo
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<ApiEnum<string, Geo>>("geo");
        }
        init
        {
            if (value == null)
            ...
            this._rawBodyData.Set("geo", value);
        }
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExternalKeyCreateParams(ExternalKeyCreateParams externalKeyCreateParams)
        : base(externalKeyCreateParams)
    {
        this._rawBodyData = new(externalKeyCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static ExternalKeyCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(ExternalKeyCreateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        ...
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/organizations/external_keys"
        )
        {
...
/// KMS provider identity and auth coordinates.
/// </summary>
[JsonConverter(typeof(ProviderConfigConverter))]
public record class ProviderConfig : ModelBase
{
    ...
    public ProviderConfig(BetaAwsExternalKeyConfig value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ProviderConfig(BetaGcpExternalKeyConfig value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ProviderConfig(BetaAzureExternalKeyConfigParam value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ProviderConfig(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of ProviderConfig"
                );
        }
    }
    ...
    public static implicit operator ProviderConfig(BetaAwsExternalKeyConfig value) => new(value);

    public static implicit operator ProviderConfig(BetaGcpExternalKeyConfig value) => new(value);

    public static implicit operator ProviderConfig(BetaAzureExternalKeyConfigParam value) =>
        new(value);
    ...
    public virtual bool Equals(ProviderConfig? other) =>
        other != null
...
sealed class ProviderConfigConverter : JsonConverter<ProviderConfig>
{
    public override ProviderConfig? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new ProviderConfig(element);
            }
        }
    }
...
/// Data residency geo. Only `us` is supported.
/// </summary>
[JsonConverter(typeof(GeoConverter))]
public enum Geo
{
    Us,
}

sealed class GeoConverter : JsonConverter<Geo>
{
    public override Geo Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
