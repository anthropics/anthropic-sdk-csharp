...
/// them directly.
///
/// <para>Acknowledge receipt of a work item, transitioning it from 'queued' to 'starting'
/// and removing it from the queue.</para>
///
/// <para>NOTE: Do not inherit from this type outside the SDK unless you're okay with
/// breaking changes in non-major versions. We may add new methods in the future that
/// cause existing derived classes to break.</para>
/// </summary>
public record class WorkAckParams : ParamsBase
{
    ...
    public WorkAckParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public WorkAckParams(WorkAckParams workAckParams)
        : base(workAckParams)
    {
        this.EnvironmentID = workAckParams.EnvironmentID;
        this.WorkID = workAckParams.WorkID;
    }
...
#pragma warning restore CS8618
    ...
    public static WorkAckParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string environmentID,
        string workID
    ...
    public virtual bool Equals(WorkAckParams? other)
    {
        if (other == null)
        {
            return false;
