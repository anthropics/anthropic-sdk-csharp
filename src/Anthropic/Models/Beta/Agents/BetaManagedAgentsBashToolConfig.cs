...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaManagedAgentsBashToolConfigFromRaw
    >)
)]
public sealed record class BetaManagedAgentsBashToolConfig : JsonModel
{
    ...
    /// </summary>
    public required BetaManagedAgentsBashToolConfigPermissionPolicy PermissionPolicy
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<BetaManagedAgentsBashToolConfigPermissionPolicy>(
                "permission_policy"
            );
        }
    ...
    public override void Validate()
    {
        ...
        if (!JsonElement.DeepEquals(this.Type, JsonSerializer.SerializeToElement("bash")))
        {
            throw new AnthropicInvalidDataException("Invalid value given for constant");
        }
    }
    ...
    public BetaManagedAgentsBashToolConfig()
    {
        ...
        this.Type = JsonSerializer.SerializeToElement("bash");
    }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BetaManagedAgentsBashToolConfig(
        BetaManagedAgentsBashToolConfig betaManagedAgentsBashToolConfig
    )
        : base(betaManagedAgentsBashToolConfig) { }
#pragma warning restore CS8618

    public BetaManagedAgentsBashToolConfig(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsBashToolConfig(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsBashToolConfigFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsBashToolConfig FromRawUnchecked(
...
class BetaManagedAgentsBashToolConfigFromRaw : IFromRawJson<BetaManagedAgentsBashToolConfig>
{
    /// <inheritdoc/>
    public BetaManagedAgentsBashToolConfig FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsBashToolConfig.FromRawUnchecked(rawData);
}

/// <summary>
/// Permission policy for tool execution.
/// </summary>
[JsonConverter(typeof(BetaManagedAgentsBashToolConfigPermissionPolicyConverter))]
public record class BetaManagedAgentsBashToolConfigPermissionPolicy : ModelBase
{
    ...
    public BetaManagedAgentsBashToolConfigPermissionPolicy(
    ...
    public BetaManagedAgentsBashToolConfigPermissionPolicy(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaManagedAgentsBashToolConfigPermissionPolicy"
                );
        }
    }
    ...
    public static implicit operator BetaManagedAgentsBashToolConfigPermissionPolicy(
        BetaManagedAgentsAlwaysAllowPolicy value
    ) => new(value);
    ...
    public virtual bool Equals(BetaManagedAgentsBashToolConfigPermissionPolicy? other) =>
        other != null
...
sealed class BetaManagedAgentsBashToolConfigPermissionPolicyConverter
    : JsonConverter<BetaManagedAgentsBashToolConfigPermissionPolicy>
{
    public override BetaManagedAgentsBashToolConfigPermissionPolicy? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsBashToolConfigPermissionPolicy(element);
            }
        }
    }
