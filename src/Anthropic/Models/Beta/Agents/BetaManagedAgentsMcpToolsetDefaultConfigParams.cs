...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaManagedAgentsMcpToolsetDefaultConfigParamsFromRaw
    >)
)]
public sealed record class BetaManagedAgentsMcpToolsetDefaultConfigParams : JsonModel
{
    /// <summary>
    ...
    public BetaManagedAgentsMcpToolsetDefaultConfigParamsPermissionPolicy? PermissionPolicy
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<BetaManagedAgentsMcpToolsetDefaultConfigParamsPermissionPolicy>(
                "permission_policy"
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BetaManagedAgentsMcpToolsetDefaultConfigParams(
        BetaManagedAgentsMcpToolsetDefaultConfigParams betaManagedAgentsMcpToolsetDefaultConfigParams
    )
        : base(betaManagedAgentsMcpToolsetDefaultConfigParams) { }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsMcpToolsetDefaultConfigParams(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsMcpToolsetDefaultConfigParamsFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsMcpToolsetDefaultConfigParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
...
class BetaManagedAgentsMcpToolsetDefaultConfigParamsFromRaw
    : IFromRawJson<BetaManagedAgentsMcpToolsetDefaultConfigParams>
{
    /// <inheritdoc/>
    public BetaManagedAgentsMcpToolsetDefaultConfigParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsMcpToolsetDefaultConfigParams.FromRawUnchecked(rawData);
}
...
public record class BetaManagedAgentsMcpToolsetDefaultConfigParamsPermissionPolicy : ModelBase
{
    ...
    public BetaManagedAgentsMcpToolsetDefaultConfigParamsPermissionPolicy(
    ...
    public BetaManagedAgentsMcpToolsetDefaultConfigParamsPermissionPolicy(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaManagedAgentsMcpToolsetDefaultConfigParamsPermissionPolicy"
                );
        }
    }
    ...
    public static implicit operator BetaManagedAgentsMcpToolsetDefaultConfigParamsPermissionPolicy(
        BetaManagedAgentsAlwaysAllowPolicy value
    ) => new(value);
    ...
    public virtual bool Equals(
        BetaManagedAgentsMcpToolsetDefaultConfigParamsPermissionPolicy? other
    ) =>
        other != null
...
sealed class BetaManagedAgentsMcpToolsetDefaultConfigParamsPermissionPolicyConverter
    : JsonConverter<BetaManagedAgentsMcpToolsetDefaultConfigParamsPermissionPolicy?>
{
    public override BetaManagedAgentsMcpToolsetDefaultConfigParamsPermissionPolicy? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsMcpToolsetDefaultConfigParamsPermissionPolicy(element);
            }
        }
    }
