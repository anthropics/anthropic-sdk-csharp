...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaManagedAgentsWriteToolConfigFromRaw
    >)
)]
public sealed record class BetaManagedAgentsWriteToolConfig : JsonModel
{
    ...
    /// </summary>
    public required BetaManagedAgentsWriteToolConfigPermissionPolicy PermissionPolicy
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<BetaManagedAgentsWriteToolConfigPermissionPolicy>(
                "permission_policy"
            );
        }
    ...
    public override void Validate()
    {
        ...
        if (!JsonElement.DeepEquals(this.Type, JsonSerializer.SerializeToElement("write")))
        {
            throw new AnthropicInvalidDataException("Invalid value given for constant");
        }
    }
    ...
    public BetaManagedAgentsWriteToolConfig()
    {
        ...
        this.Type = JsonSerializer.SerializeToElement("write");
    }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BetaManagedAgentsWriteToolConfig(
        BetaManagedAgentsWriteToolConfig betaManagedAgentsWriteToolConfig
    )
        : base(betaManagedAgentsWriteToolConfig) { }
#pragma warning restore CS8618

    public BetaManagedAgentsWriteToolConfig(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsWriteToolConfig(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsWriteToolConfigFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsWriteToolConfig FromRawUnchecked(
...
class BetaManagedAgentsWriteToolConfigFromRaw : IFromRawJson<BetaManagedAgentsWriteToolConfig>
{
    /// <inheritdoc/>
    public BetaManagedAgentsWriteToolConfig FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsWriteToolConfig.FromRawUnchecked(rawData);
}

/// <summary>
/// Permission policy for tool execution.
/// </summary>
[JsonConverter(typeof(BetaManagedAgentsWriteToolConfigPermissionPolicyConverter))]
public record class BetaManagedAgentsWriteToolConfigPermissionPolicy : ModelBase
{
    ...
    public BetaManagedAgentsWriteToolConfigPermissionPolicy(
    ...
    public BetaManagedAgentsWriteToolConfigPermissionPolicy(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaManagedAgentsWriteToolConfigPermissionPolicy"
                );
        }
    }
    ...
    public static implicit operator BetaManagedAgentsWriteToolConfigPermissionPolicy(
        BetaManagedAgentsAlwaysAllowPolicy value
    ) => new(value);
    ...
    public virtual bool Equals(BetaManagedAgentsWriteToolConfigPermissionPolicy? other) =>
        other != null
...
sealed class BetaManagedAgentsWriteToolConfigPermissionPolicyConverter
    : JsonConverter<BetaManagedAgentsWriteToolConfigPermissionPolicy>
{
    public override BetaManagedAgentsWriteToolConfigPermissionPolicy? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsWriteToolConfigPermissionPolicy(element);
            }
        }
    }
