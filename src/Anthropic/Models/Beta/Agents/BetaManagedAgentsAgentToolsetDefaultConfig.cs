...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaManagedAgentsAgentToolsetDefaultConfigFromRaw
    >)
)]
public sealed record class BetaManagedAgentsAgentToolsetDefaultConfig : JsonModel
{
...
#pragma warning disable CS8618
    ...
    public BetaManagedAgentsAgentToolsetDefaultConfig(
        ...
        : base(betaManagedAgentsAgentToolsetDefaultConfig) { }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsAgentToolsetDefaultConfig(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsAgentToolsetDefaultConfigFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsAgentToolsetDefaultConfig FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
...
class BetaManagedAgentsAgentToolsetDefaultConfigFromRaw
    : IFromRawJson<BetaManagedAgentsAgentToolsetDefaultConfig>
{
    /// <inheritdoc/>
    public BetaManagedAgentsAgentToolsetDefaultConfig FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsAgentToolsetDefaultConfig.FromRawUnchecked(rawData);
}
...
public record class PermissionPolicy : ModelBase
{
    ...
    public PermissionPolicy(BetaManagedAgentsAutoPolicy value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }
    ...
    public static implicit operator PermissionPolicy(BetaManagedAgentsAutoPolicy value) =>
        new(value);
