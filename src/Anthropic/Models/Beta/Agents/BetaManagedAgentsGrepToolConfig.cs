...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaManagedAgentsGrepToolConfigFromRaw
    >)
)]
public sealed record class BetaManagedAgentsGrepToolConfig : JsonModel
{
    ...
    /// </summary>
    public required BetaManagedAgentsGrepToolConfigPermissionPolicy PermissionPolicy
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<BetaManagedAgentsGrepToolConfigPermissionPolicy>(
                "permission_policy"
            );
        }
    ...
    public override void Validate()
    {
        ...
        if (!JsonElement.DeepEquals(this.Type, JsonSerializer.SerializeToElement("grep")))
        {
            throw new AnthropicInvalidDataException("Invalid value given for constant");
        }
    }
    ...
    public BetaManagedAgentsGrepToolConfig()
    {
        ...
        this.Type = JsonSerializer.SerializeToElement("grep");
    }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BetaManagedAgentsGrepToolConfig(
        BetaManagedAgentsGrepToolConfig betaManagedAgentsGrepToolConfig
    )
        : base(betaManagedAgentsGrepToolConfig) { }
#pragma warning restore CS8618

    public BetaManagedAgentsGrepToolConfig(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsGrepToolConfig(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsGrepToolConfigFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsGrepToolConfig FromRawUnchecked(
...
class BetaManagedAgentsGrepToolConfigFromRaw : IFromRawJson<BetaManagedAgentsGrepToolConfig>
{
    /// <inheritdoc/>
    public BetaManagedAgentsGrepToolConfig FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsGrepToolConfig.FromRawUnchecked(rawData);
}

/// <summary>
/// Permission policy for tool execution.
/// </summary>
[JsonConverter(typeof(BetaManagedAgentsGrepToolConfigPermissionPolicyConverter))]
public record class BetaManagedAgentsGrepToolConfigPermissionPolicy : ModelBase
{
    ...
    public BetaManagedAgentsGrepToolConfigPermissionPolicy(
    ...
    public BetaManagedAgentsGrepToolConfigPermissionPolicy(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaManagedAgentsGrepToolConfigPermissionPolicy"
                );
        }
    }
    ...
    public static implicit operator BetaManagedAgentsGrepToolConfigPermissionPolicy(
        BetaManagedAgentsAlwaysAllowPolicy value
    ) => new(value);
    ...
    public virtual bool Equals(BetaManagedAgentsGrepToolConfigPermissionPolicy? other) =>
        other != null
...
sealed class BetaManagedAgentsGrepToolConfigPermissionPolicyConverter
    : JsonConverter<BetaManagedAgentsGrepToolConfigPermissionPolicy>
{
    public override BetaManagedAgentsGrepToolConfigPermissionPolicy? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsGrepToolConfigPermissionPolicy(element);
            }
        }
    }
    ...
    public override void Write(
        ...
        BetaManagedAgentsGrepToolConfigPermissionPolicy value,
        JsonSerializerOptions options
    )
    {
