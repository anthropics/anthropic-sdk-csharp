...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaManagedAgentsMcpToolsetDefaultConfigFromRaw
    >)
)]
public sealed record class BetaManagedAgentsMcpToolsetDefaultConfig : JsonModel
{
    ...
    /// </summary>
    public required BetaManagedAgentsMcpToolsetDefaultConfigPermissionPolicy PermissionPolicy
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<BetaManagedAgentsMcpToolsetDefaultConfigPermissionPolicy>(
                "permission_policy"
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BetaManagedAgentsMcpToolsetDefaultConfig(
        BetaManagedAgentsMcpToolsetDefaultConfig betaManagedAgentsMcpToolsetDefaultConfig
    )
        : base(betaManagedAgentsMcpToolsetDefaultConfig) { }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsMcpToolsetDefaultConfig(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsMcpToolsetDefaultConfigFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsMcpToolsetDefaultConfig FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
...
class BetaManagedAgentsMcpToolsetDefaultConfigFromRaw
    : IFromRawJson<BetaManagedAgentsMcpToolsetDefaultConfig>
{
    /// <inheritdoc/>
    public BetaManagedAgentsMcpToolsetDefaultConfig FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsMcpToolsetDefaultConfig.FromRawUnchecked(rawData);
}

/// <summary>
/// Permission policy for tool execution.
/// </summary>
[JsonConverter(typeof(BetaManagedAgentsMcpToolsetDefaultConfigPermissionPolicyConverter))]
public record class BetaManagedAgentsMcpToolsetDefaultConfigPermissionPolicy : ModelBase
{
    ...
    public BetaManagedAgentsMcpToolsetDefaultConfigPermissionPolicy(
    ...
    public BetaManagedAgentsMcpToolsetDefaultConfigPermissionPolicy(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaManagedAgentsMcpToolsetDefaultConfigPermissionPolicy"
                );
        }
    }
    ...
    public static implicit operator BetaManagedAgentsMcpToolsetDefaultConfigPermissionPolicy(
        BetaManagedAgentsAlwaysAllowPolicy value
    ) => new(value);
    ...
    public virtual bool Equals(BetaManagedAgentsMcpToolsetDefaultConfigPermissionPolicy? other) =>
        other != null
...
sealed class BetaManagedAgentsMcpToolsetDefaultConfigPermissionPolicyConverter
    : JsonConverter<BetaManagedAgentsMcpToolsetDefaultConfigPermissionPolicy>
{
    public override BetaManagedAgentsMcpToolsetDefaultConfigPermissionPolicy? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsMcpToolsetDefaultConfigPermissionPolicy(element);
            }
        }
    }
