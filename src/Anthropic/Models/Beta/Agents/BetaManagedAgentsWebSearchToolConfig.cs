...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaManagedAgentsWebSearchToolConfigFromRaw
    >)
)]
public sealed record class BetaManagedAgentsWebSearchToolConfig : JsonModel
{
    ...
    /// </summary>
    public required BetaManagedAgentsWebSearchToolConfigPermissionPolicy PermissionPolicy
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<BetaManagedAgentsWebSearchToolConfigPermissionPolicy>(
                "permission_policy"
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BetaManagedAgentsWebSearchToolConfig(
        BetaManagedAgentsWebSearchToolConfig betaManagedAgentsWebSearchToolConfig
    )
        : base(betaManagedAgentsWebSearchToolConfig) { }
#pragma warning restore CS8618

    public BetaManagedAgentsWebSearchToolConfig(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsWebSearchToolConfig(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsWebSearchToolConfigFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsWebSearchToolConfig FromRawUnchecked(
...
class BetaManagedAgentsWebSearchToolConfigFromRaw
    : IFromRawJson<BetaManagedAgentsWebSearchToolConfig>
{
    /// <inheritdoc/>
    public BetaManagedAgentsWebSearchToolConfig FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsWebSearchToolConfig.FromRawUnchecked(rawData);
}

/// <summary>
/// Permission policy for tool execution.
/// </summary>
[JsonConverter(typeof(BetaManagedAgentsWebSearchToolConfigPermissionPolicyConverter))]
public record class BetaManagedAgentsWebSearchToolConfigPermissionPolicy : ModelBase
{
    ...
    public BetaManagedAgentsWebSearchToolConfigPermissionPolicy(
    ...
    public BetaManagedAgentsWebSearchToolConfigPermissionPolicy(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaManagedAgentsWebSearchToolConfigPermissionPolicy"
                );
        }
    }
    ...
    public static implicit operator BetaManagedAgentsWebSearchToolConfigPermissionPolicy(
        BetaManagedAgentsAlwaysAllowPolicy value
    ) => new(value);
    ...
    public virtual bool Equals(BetaManagedAgentsWebSearchToolConfigPermissionPolicy? other) =>
        other != null
...
sealed class BetaManagedAgentsWebSearchToolConfigPermissionPolicyConverter
    : JsonConverter<BetaManagedAgentsWebSearchToolConfigPermissionPolicy>
{
    public override BetaManagedAgentsWebSearchToolConfigPermissionPolicy? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsWebSearchToolConfigPermissionPolicy(element);
            }
        }
    }
