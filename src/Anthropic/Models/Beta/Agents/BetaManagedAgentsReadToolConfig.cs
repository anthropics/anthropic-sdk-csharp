...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaManagedAgentsReadToolConfigFromRaw
    >)
)]
public sealed record class BetaManagedAgentsReadToolConfig : JsonModel
{
    ...
    /// </summary>
    public required BetaManagedAgentsReadToolConfigPermissionPolicy PermissionPolicy
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<BetaManagedAgentsReadToolConfigPermissionPolicy>(
                "permission_policy"
            );
        }
    ...
    public override void Validate()
    {
        ...
        if (!JsonElement.DeepEquals(this.Type, JsonSerializer.SerializeToElement("read")))
        {
            throw new AnthropicInvalidDataException("Invalid value given for constant");
        }
    }
    ...
    public BetaManagedAgentsReadToolConfig()
    {
        ...
        this.Type = JsonSerializer.SerializeToElement("read");
    }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BetaManagedAgentsReadToolConfig(
        BetaManagedAgentsReadToolConfig betaManagedAgentsReadToolConfig
    )
        : base(betaManagedAgentsReadToolConfig) { }
#pragma warning restore CS8618

    public BetaManagedAgentsReadToolConfig(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsReadToolConfig(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsReadToolConfigFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsReadToolConfig FromRawUnchecked(
...
class BetaManagedAgentsReadToolConfigFromRaw : IFromRawJson<BetaManagedAgentsReadToolConfig>
{
    /// <inheritdoc/>
    public BetaManagedAgentsReadToolConfig FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsReadToolConfig.FromRawUnchecked(rawData);
}

/// <summary>
/// Permission policy for tool execution.
/// </summary>
[JsonConverter(typeof(BetaManagedAgentsReadToolConfigPermissionPolicyConverter))]
public record class BetaManagedAgentsReadToolConfigPermissionPolicy : ModelBase
{
    ...
    public BetaManagedAgentsReadToolConfigPermissionPolicy(
    ...
    public BetaManagedAgentsReadToolConfigPermissionPolicy(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaManagedAgentsReadToolConfigPermissionPolicy"
                );
        }
    }
    ...
    public static implicit operator BetaManagedAgentsReadToolConfigPermissionPolicy(
        BetaManagedAgentsAlwaysAllowPolicy value
    ) => new(value);
    ...
    public virtual bool Equals(BetaManagedAgentsReadToolConfigPermissionPolicy? other) =>
        other != null
...
sealed class BetaManagedAgentsReadToolConfigPermissionPolicyConverter
    : JsonConverter<BetaManagedAgentsReadToolConfigPermissionPolicy>
{
    public override BetaManagedAgentsReadToolConfigPermissionPolicy? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsReadToolConfigPermissionPolicy(element);
            }
        }
    }
    ...
    public override void Write(
        ...
        BetaManagedAgentsReadToolConfigPermissionPolicy value,
        JsonSerializerOptions options
    )
    {
