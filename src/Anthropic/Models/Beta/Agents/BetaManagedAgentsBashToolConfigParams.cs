...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaManagedAgentsBashToolConfigParamsFromRaw
    >)
)]
public sealed record class BetaManagedAgentsBashToolConfigParams : JsonModel
{
    /// <summary>
    /// Must be "bash".
    /// </summary>
    ...
    /// </summary>
    public BetaManagedAgentsBashToolConfigParamsPermissionPolicy? PermissionPolicy
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<BetaManagedAgentsBashToolConfigParamsPermissionPolicy>(
                "permission_policy"
            );
        }
    ...
    public ApiEnum<string, BetaManagedAgentsBashToolConfigParamsType>? Type
    {
        get
        {
            this._rawData.Freeze();
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BetaManagedAgentsBashToolConfigParams(
        BetaManagedAgentsBashToolConfigParams betaManagedAgentsBashToolConfigParams
    )
        : base(betaManagedAgentsBashToolConfigParams) { }
#pragma warning restore CS8618

    public BetaManagedAgentsBashToolConfigParams(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsBashToolConfigParams(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsBashToolConfigParamsFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsBashToolConfigParams FromRawUnchecked(
...
class BetaManagedAgentsBashToolConfigParamsFromRaw
    : IFromRawJson<BetaManagedAgentsBashToolConfigParams>
{
    /// <inheritdoc/>
    public BetaManagedAgentsBashToolConfigParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsBashToolConfigParams.FromRawUnchecked(rawData);
}

/// <summary>
/// Permission policy for tool execution.
/// </summary>
[JsonConverter(typeof(BetaManagedAgentsBashToolConfigParamsPermissionPolicyConverter))]
public record class BetaManagedAgentsBashToolConfigParamsPermissionPolicy : ModelBase
{
    ...
    public virtual bool Equals(BetaManagedAgentsBashToolConfigParamsPermissionPolicy? other) =>
        other != null
...
sealed class BetaManagedAgentsBashToolConfigParamsPermissionPolicyConverter
    : JsonConverter<BetaManagedAgentsBashToolConfigParamsPermissionPolicy?>
{
    public override BetaManagedAgentsBashToolConfigParamsPermissionPolicy? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsBashToolConfigParamsPermissionPolicy(element);
            }
        }
    }
...
[JsonConverter(typeof(BetaManagedAgentsBashToolConfigParamsTypeConverter))]
public enum BetaManagedAgentsBashToolConfigParamsType
{
    Bash,
}

sealed class BetaManagedAgentsBashToolConfigParamsTypeConverter
    : JsonConverter<BetaManagedAgentsBashToolConfigParamsType>
{
    public override BetaManagedAgentsBashToolConfigParamsType Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        ...
        {
            "bash" => BetaManagedAgentsBashToolConfigParamsType.Bash,
            _ => (BetaManagedAgentsBashToolConfigParamsType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        BetaManagedAgentsBashToolConfigParamsType value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                BetaManagedAgentsBashToolConfigParamsType.Bash => "bash",
                _ => throw new AnthropicInvalidDataException(
