...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaManagedAgentsMcpConnectionFailedErrorFromRaw
    >)
)]
public sealed record class BetaManagedAgentsMcpConnectionFailedError : JsonModel
{
    /// <summary>
    ...
    public required BetaManagedAgentsMcpConnectionFailedErrorRetryStatus RetryStatus
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<BetaManagedAgentsMcpConnectionFailedErrorRetryStatus>(
                "retry_status"
            );
        }
    ...
    public required ApiEnum<string, BetaManagedAgentsMcpConnectionFailedErrorType> Type
    {
        get
        {
            this._rawData.Freeze();
...
#pragma warning disable CS8618
    ...
    public BetaManagedAgentsMcpConnectionFailedError(
        ...
        : base(betaManagedAgentsMcpConnectionFailedError) { }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsMcpConnectionFailedError(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsMcpConnectionFailedErrorFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsMcpConnectionFailedError FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
...
class BetaManagedAgentsMcpConnectionFailedErrorFromRaw
    : IFromRawJson<BetaManagedAgentsMcpConnectionFailedError>
{
    /// <inheritdoc/>
    public BetaManagedAgentsMcpConnectionFailedError FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsMcpConnectionFailedError.FromRawUnchecked(rawData);
}
...
public record class BetaManagedAgentsMcpConnectionFailedErrorRetryStatus : ModelBase
{
    ...
    public BetaManagedAgentsMcpConnectionFailedErrorRetryStatus(
    ...
    public BetaManagedAgentsMcpConnectionFailedErrorRetryStatus(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaManagedAgentsMcpConnectionFailedErrorRetryStatus"
                );
        }
    }
    ...
    public static implicit operator BetaManagedAgentsMcpConnectionFailedErrorRetryStatus(
        BetaManagedAgentsRetryStatusRetrying value
    ) => new(value);
    ...
    public virtual bool Equals(BetaManagedAgentsMcpConnectionFailedErrorRetryStatus? other) =>
        other != null
...
sealed class BetaManagedAgentsMcpConnectionFailedErrorRetryStatusConverter
    : JsonConverter<BetaManagedAgentsMcpConnectionFailedErrorRetryStatus>
{
    public override BetaManagedAgentsMcpConnectionFailedErrorRetryStatus? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsMcpConnectionFailedErrorRetryStatus(element);
            }
        }
    }
...
[JsonConverter(typeof(BetaManagedAgentsMcpConnectionFailedErrorTypeConverter))]
public enum BetaManagedAgentsMcpConnectionFailedErrorType
{
    McpConnectionFailedError,
}

sealed class BetaManagedAgentsMcpConnectionFailedErrorTypeConverter
    : JsonConverter<BetaManagedAgentsMcpConnectionFailedErrorType>
{
    public override BetaManagedAgentsMcpConnectionFailedErrorType Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            ...
            _ => (BetaManagedAgentsMcpConnectionFailedErrorType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        BetaManagedAgentsMcpConnectionFailedErrorType value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
