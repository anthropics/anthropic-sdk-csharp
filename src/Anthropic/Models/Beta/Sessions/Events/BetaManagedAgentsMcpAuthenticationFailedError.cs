...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaManagedAgentsMcpAuthenticationFailedErrorFromRaw
    >)
)]
public sealed record class BetaManagedAgentsMcpAuthenticationFailedError : JsonModel
{
    /// <summary>
    ...
    public required BetaManagedAgentsMcpAuthenticationFailedErrorRetryStatus RetryStatus
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<BetaManagedAgentsMcpAuthenticationFailedErrorRetryStatus>(
                "retry_status"
            );
        }
    ...
    public required ApiEnum<string, BetaManagedAgentsMcpAuthenticationFailedErrorType> Type
    {
        get
        {
            this._rawData.Freeze();
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BetaManagedAgentsMcpAuthenticationFailedError(
        BetaManagedAgentsMcpAuthenticationFailedError betaManagedAgentsMcpAuthenticationFailedError
    )
        : base(betaManagedAgentsMcpAuthenticationFailedError) { }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsMcpAuthenticationFailedError(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsMcpAuthenticationFailedErrorFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsMcpAuthenticationFailedError FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
...
class BetaManagedAgentsMcpAuthenticationFailedErrorFromRaw
    : IFromRawJson<BetaManagedAgentsMcpAuthenticationFailedError>
{
    /// <inheritdoc/>
    public BetaManagedAgentsMcpAuthenticationFailedError FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsMcpAuthenticationFailedError.FromRawUnchecked(rawData);
}
...
public record class BetaManagedAgentsMcpAuthenticationFailedErrorRetryStatus : ModelBase
{
    ...
    public BetaManagedAgentsMcpAuthenticationFailedErrorRetryStatus(
    ...
    public BetaManagedAgentsMcpAuthenticationFailedErrorRetryStatus(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaManagedAgentsMcpAuthenticationFailedErrorRetryStatus"
                );
        }
    }
    ...
    public static implicit operator BetaManagedAgentsMcpAuthenticationFailedErrorRetryStatus(
        BetaManagedAgentsRetryStatusRetrying value
    ) => new(value);
    ...
    public virtual bool Equals(BetaManagedAgentsMcpAuthenticationFailedErrorRetryStatus? other) =>
        other != null
...
sealed class BetaManagedAgentsMcpAuthenticationFailedErrorRetryStatusConverter
    : JsonConverter<BetaManagedAgentsMcpAuthenticationFailedErrorRetryStatus>
{
    public override BetaManagedAgentsMcpAuthenticationFailedErrorRetryStatus? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsMcpAuthenticationFailedErrorRetryStatus(element);
            }
        }
    }
...
[JsonConverter(typeof(BetaManagedAgentsMcpAuthenticationFailedErrorTypeConverter))]
public enum BetaManagedAgentsMcpAuthenticationFailedErrorType
{
    McpAuthenticationFailedError,
}

sealed class BetaManagedAgentsMcpAuthenticationFailedErrorTypeConverter
    : JsonConverter<BetaManagedAgentsMcpAuthenticationFailedErrorType>
{
    public override BetaManagedAgentsMcpAuthenticationFailedErrorType Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            ...
            _ => (BetaManagedAgentsMcpAuthenticationFailedErrorType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        BetaManagedAgentsMcpAuthenticationFailedErrorType value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
