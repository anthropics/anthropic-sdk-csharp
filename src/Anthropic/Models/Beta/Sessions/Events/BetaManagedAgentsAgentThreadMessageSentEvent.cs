...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaManagedAgentsAgentThreadMessageSentEventFromRaw
    >)
)]
public sealed record class BetaManagedAgentsAgentThreadMessageSentEvent : JsonModel
{
    /// <summary>
    ...
    /// </summary>
    public required IReadOnlyList<BetaManagedAgentsAgentThreadMessageSentEventContent> Content
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<
                ImmutableArray<BetaManagedAgentsAgentThreadMessageSentEventContent>
            >("content");
        }
        init
        {
            this._rawData.Set<ImmutableArray<BetaManagedAgentsAgentThreadMessageSentEventContent>>(
                "content",
    ...
    /// </summary>
    public required string ToSessionThreadID
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<string>("to_session_thread_id");
        }
        init { this._rawData.Set("to_session_thread_id", value); }
    }

    public required ApiEnum<string, BetaManagedAgentsAgentThreadMessageSentEventType> Type
    {
        get
        {
            this._rawData.Freeze();
    ...
    /// <summary>
    /// Name of the callable agent this message was sent to. Absent when sent to
    /// the primary agent.
    /// </summary>
    public string? ToAgentName
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<string>("to_agent_name");
        }
        init { this._rawData.Set("to_agent_name", value); }
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BetaManagedAgentsAgentThreadMessageSentEvent(
        BetaManagedAgentsAgentThreadMessageSentEvent betaManagedAgentsAgentThreadMessageSentEvent
    )
        : base(betaManagedAgentsAgentThreadMessageSentEvent) { }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsAgentThreadMessageSentEvent(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsAgentThreadMessageSentEventFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsAgentThreadMessageSentEvent FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
...
class BetaManagedAgentsAgentThreadMessageSentEventFromRaw
    : IFromRawJson<BetaManagedAgentsAgentThreadMessageSentEvent>
{
    /// <inheritdoc/>
    public BetaManagedAgentsAgentThreadMessageSentEvent FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsAgentThreadMessageSentEvent.FromRawUnchecked(rawData);
}

/// <summary>
/// Content block in a user message. Can be `text`, `image`, or `document`.
/// </summary>
[JsonConverter(typeof(BetaManagedAgentsAgentThreadMessageSentEventContentConverter))]
public record class BetaManagedAgentsAgentThreadMessageSentEventContent : ModelBase
{
    ...
    public virtual bool Equals(BetaManagedAgentsAgentThreadMessageSentEventContent? other) =>
        other != null
...
sealed class BetaManagedAgentsAgentThreadMessageSentEventContentConverter
    : JsonConverter<BetaManagedAgentsAgentThreadMessageSentEventContent>
{
    public override BetaManagedAgentsAgentThreadMessageSentEventContent? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsAgentThreadMessageSentEventContent(element);
            }
        }
    }
...
[JsonConverter(typeof(BetaManagedAgentsAgentThreadMessageSentEventTypeConverter))]
public enum BetaManagedAgentsAgentThreadMessageSentEventType
{
    AgentThreadMessageSent,
}

sealed class BetaManagedAgentsAgentThreadMessageSentEventTypeConverter
    : JsonConverter<BetaManagedAgentsAgentThreadMessageSentEventType>
{
    public override BetaManagedAgentsAgentThreadMessageSentEventType Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            ...
            _ => (BetaManagedAgentsAgentThreadMessageSentEventType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        BetaManagedAgentsAgentThreadMessageSentEventType value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
