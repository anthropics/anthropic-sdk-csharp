...
/// <summary>
/// Parameters for providing the result of an agent-toolset tool execution. Only valid
/// on `self_hosted` environments, where sandbox-routed tools are executed by the
/// client rather than the server.
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<
        BetaManagedAgentsUserToolResultEventParams,
        BetaManagedAgentsUserToolResultEventParamsFromRaw
    >)
)]
public sealed record class BetaManagedAgentsUserToolResultEventParams : JsonModel
{
    /// <summary>
    ...
    public required ApiEnum<string, BetaManagedAgentsUserToolResultEventParamsType> Type
    {
        get
        {
            this._rawData.Freeze();
    ...
    /// </summary>
    public IReadOnlyList<BetaManagedAgentsUserToolResultEventParamsContent>? Content
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableStruct<
                ImmutableArray<BetaManagedAgentsUserToolResultEventParamsContent>
            >("content");
        }
        init
        {
            ...
            this._rawData.Set<ImmutableArray<BetaManagedAgentsUserToolResultEventParamsContent>?>(
                "content",
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BetaManagedAgentsUserToolResultEventParams(
        BetaManagedAgentsUserToolResultEventParams betaManagedAgentsUserToolResultEventParams
    )
        : base(betaManagedAgentsUserToolResultEventParams) { }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsUserToolResultEventParams(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsUserToolResultEventParamsFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsUserToolResultEventParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
...
class BetaManagedAgentsUserToolResultEventParamsFromRaw
    : IFromRawJson<BetaManagedAgentsUserToolResultEventParams>
{
    /// <inheritdoc/>
    public BetaManagedAgentsUserToolResultEventParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsUserToolResultEventParams.FromRawUnchecked(rawData);
}

[JsonConverter(typeof(BetaManagedAgentsUserToolResultEventParamsTypeConverter))]
public enum BetaManagedAgentsUserToolResultEventParamsType
{
    UserToolResult,
}

sealed class BetaManagedAgentsUserToolResultEventParamsTypeConverter
    : JsonConverter<BetaManagedAgentsUserToolResultEventParamsType>
{
    public override BetaManagedAgentsUserToolResultEventParamsType Read(
    ...
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            ...
            _ => (BetaManagedAgentsUserToolResultEventParamsType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        BetaManagedAgentsUserToolResultEventParamsType value,
        JsonSerializerOptions options
    )
    {
...
/// </summary>
[JsonConverter(typeof(BetaManagedAgentsUserToolResultEventParamsContentConverter))]
public record class BetaManagedAgentsUserToolResultEventParamsContent : ModelBase
{
    ...
    public BetaManagedAgentsUserToolResultEventParamsContent(
    ...
    public BetaManagedAgentsUserToolResultEventParamsContent(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaManagedAgentsUserToolResultEventParamsContent"
                );
        }
    }
    ...
    public static implicit operator BetaManagedAgentsUserToolResultEventParamsContent(
        BetaManagedAgentsTextBlock value
    ) => new(value);
    ...
    public virtual bool Equals(BetaManagedAgentsUserToolResultEventParamsContent? other) =>
        other != null
...
sealed class BetaManagedAgentsUserToolResultEventParamsContentConverter
    : JsonConverter<BetaManagedAgentsUserToolResultEventParamsContent>
{
    public override BetaManagedAgentsUserToolResultEventParamsContent? Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsUserToolResultEventParamsContent(element);
            }
        }
    }
