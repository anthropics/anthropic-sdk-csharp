...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BetaManagedAgentsCredentialHostUnreachableErrorFromRaw
    >)
)]
public sealed record class BetaManagedAgentsCredentialHostUnreachableError : JsonModel
{
    /// <summary>
    ...
    public required BetaManagedAgentsCredentialHostUnreachableErrorRetryStatus RetryStatus
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<BetaManagedAgentsCredentialHostUnreachableErrorRetryStatus>(
                "retry_status"
            );
        }
    ...
    public required ApiEnum<string, BetaManagedAgentsCredentialHostUnreachableErrorType> Type
    {
        get
        {
            this._rawData.Freeze();
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BetaManagedAgentsCredentialHostUnreachableError(
        BetaManagedAgentsCredentialHostUnreachableError betaManagedAgentsCredentialHostUnreachableError
    )
        : base(betaManagedAgentsCredentialHostUnreachableError) { }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaManagedAgentsCredentialHostUnreachableError(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BetaManagedAgentsCredentialHostUnreachableErrorFromRaw.FromRawUnchecked"/>
    public static BetaManagedAgentsCredentialHostUnreachableError FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
...
class BetaManagedAgentsCredentialHostUnreachableErrorFromRaw
    : IFromRawJson<BetaManagedAgentsCredentialHostUnreachableError>
{
    /// <inheritdoc/>
    public BetaManagedAgentsCredentialHostUnreachableError FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BetaManagedAgentsCredentialHostUnreachableError.FromRawUnchecked(rawData);
}
...
public record class BetaManagedAgentsCredentialHostUnreachableErrorRetryStatus : ModelBase
{
    ...
    public BetaManagedAgentsCredentialHostUnreachableErrorRetryStatus(
    ...
    public BetaManagedAgentsCredentialHostUnreachableErrorRetryStatus(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new AnthropicInvalidDataException(
                    "Data did not match any variant of BetaManagedAgentsCredentialHostUnreachableErrorRetryStatus"
                );
        }
    }
    ...
    public static implicit operator BetaManagedAgentsCredentialHostUnreachableErrorRetryStatus(
        BetaManagedAgentsRetryStatusRetrying value
    ) => new(value);
    ...
    public virtual bool Equals(BetaManagedAgentsCredentialHostUnreachableErrorRetryStatus? other) =>
        other != null
...
sealed class BetaManagedAgentsCredentialHostUnreachableErrorRetryStatusConverter
    : JsonConverter<BetaManagedAgentsCredentialHostUnreachableErrorRetryStatus>
{
    public override BetaManagedAgentsCredentialHostUnreachableErrorRetryStatus? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new BetaManagedAgentsCredentialHostUnreachableErrorRetryStatus(element);
            }
        }
    }
...
[JsonConverter(typeof(BetaManagedAgentsCredentialHostUnreachableErrorTypeConverter))]
public enum BetaManagedAgentsCredentialHostUnreachableErrorType
{
    CredentialHostUnreachableError,
}

sealed class BetaManagedAgentsCredentialHostUnreachableErrorTypeConverter
    : JsonConverter<BetaManagedAgentsCredentialHostUnreachableErrorType>
{
    public override BetaManagedAgentsCredentialHostUnreachableErrorType Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            ...
            _ => (BetaManagedAgentsCredentialHostUnreachableErrorType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        BetaManagedAgentsCredentialHostUnreachableErrorType value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
