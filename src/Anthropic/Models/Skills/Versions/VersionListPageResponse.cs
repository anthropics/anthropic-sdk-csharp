...
public sealed record class VersionListPageResponse : JsonModel
{
    ...
    /// List of skills.
    /// </summary>
    public required IReadOnlyList<SkillVersion> Data
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<ImmutableArray<SkillVersion>>("data");
        }
        init
        {
            this._rawData.Set<ImmutableArray<SkillVersion>>(
                "data",
