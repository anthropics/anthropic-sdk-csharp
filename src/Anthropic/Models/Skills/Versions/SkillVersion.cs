...
[JsonConverter(typeof(JsonModelConverter<SkillVersion, SkillVersionFromRaw>))]
public sealed record class SkillVersion : JsonModel
{
    /// <summary>
...
#pragma warning restore CS8618
    ...
    public SkillVersion(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    SkillVersion(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="SkillVersionFromRaw.FromRawUnchecked"/>
    public static SkillVersion FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    }
}

class SkillVersionFromRaw : IFromRawJson<SkillVersion>
{
    /// <inheritdoc/>
    public SkillVersion FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        SkillVersion.FromRawUnchecked(rawData);
}
