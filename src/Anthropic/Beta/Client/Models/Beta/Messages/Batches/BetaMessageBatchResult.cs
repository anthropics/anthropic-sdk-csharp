...
using BetaMessageBatchResultVariants = Anthropic.Beta.Client.Models.Beta.Messages.Batches.BetaMessageBatchResultVariants;

namespace Anthropic.Beta.Client.Models.Beta.Messages.Batches;
