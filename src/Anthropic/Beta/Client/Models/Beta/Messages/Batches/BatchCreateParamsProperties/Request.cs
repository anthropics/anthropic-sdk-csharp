...
using Anthropic.Beta.Client.Models.Beta.Messages.Batches.BatchCreateParamsProperties.RequestProperties;

namespace Anthropic.Beta.Client.Models.Beta.Messages.Batches.BatchCreateParamsProperties;
