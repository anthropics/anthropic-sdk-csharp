using Batches = Anthropic.Beta.Client.Models.Beta.Messages.Batches;

namespace Anthropic.Beta.Client.Models.Beta.Messages.Batches.BetaMessageBatchResultVariants;
