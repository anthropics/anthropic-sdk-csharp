...
using ContentVariants = Anthropic.Beta.Client.Models.Beta.Messages.BetaMessageParamProperties.ContentVariants;

namespace Anthropic.Beta.Client.Models.Beta.Messages.BetaMessageParamProperties;
