...
using CitationVariants = Anthropic.Beta.Client.Models.Beta.Messages.BetaCitationsDeltaProperties.CitationVariants;

namespace Anthropic.Beta.Client.Models.Beta.Messages.BetaCitationsDeltaProperties;
