...
using ContentVariants = Anthropic.Beta.Client.Models.Beta.Messages.BetaMCPToolResultBlockProperties.ContentVariants;

namespace Anthropic.Beta.Client.Models.Beta.Messages.BetaMCPToolResultBlockProperties;
