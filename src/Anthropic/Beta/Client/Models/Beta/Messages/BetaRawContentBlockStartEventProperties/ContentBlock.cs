...
using ContentBlockVariants = Anthropic.Beta.Client.Models.Beta.Messages.BetaRawContentBlockStartEventProperties.ContentBlockVariants;

namespace Anthropic.Beta.Client.Models.Beta.Messages.BetaRawContentBlockStartEventProperties;
