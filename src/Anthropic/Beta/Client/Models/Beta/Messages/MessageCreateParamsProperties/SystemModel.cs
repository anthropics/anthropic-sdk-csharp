...
using SystemVariants = Anthropic.Beta.Client.Models.Beta.Messages.MessageCreateParamsProperties.SystemVariants;

namespace Anthropic.Beta.Client.Models.Beta.Messages.MessageCreateParamsProperties;
