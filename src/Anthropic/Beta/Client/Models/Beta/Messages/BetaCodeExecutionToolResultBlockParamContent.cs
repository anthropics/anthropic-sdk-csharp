...
using BetaCodeExecutionToolResultBlockParamContentVariants = Anthropic.Beta.Client.Models.Beta.Messages.BetaCodeExecutionToolResultBlockParamContentVariants;

namespace Anthropic.Beta.Client.Models.Beta.Messages;
