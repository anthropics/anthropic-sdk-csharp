...
using ContentVariants = Anthropic.Beta.Client.Models.Beta.Messages.BetaRequestMCPToolResultBlockParamProperties.ContentVariants;

namespace Anthropic.Beta.Client.Models.Beta.Messages.BetaRequestMCPToolResultBlockParamProperties;
