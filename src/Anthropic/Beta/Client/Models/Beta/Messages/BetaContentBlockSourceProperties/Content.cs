...
using ContentVariants = Anthropic.Beta.Client.Models.Beta.Messages.BetaContentBlockSourceProperties.ContentVariants;

namespace Anthropic.Beta.Client.Models.Beta.Messages.BetaContentBlockSourceProperties;
