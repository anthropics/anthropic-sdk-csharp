...
using SourceVariants = Anthropic.Beta.Client.Models.Beta.Messages.BetaRequestDocumentBlockProperties.SourceVariants;

namespace Anthropic.Beta.Client.Models.Beta.Messages.BetaRequestDocumentBlockProperties;
