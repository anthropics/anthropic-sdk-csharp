...
using SystemVariants = Anthropic.Beta.Client.Models.Beta.Messages.MessageCountTokensParamsProperties.SystemVariants;

namespace Anthropic.Beta.Client.Models.Beta.Messages.MessageCountTokensParamsProperties;
