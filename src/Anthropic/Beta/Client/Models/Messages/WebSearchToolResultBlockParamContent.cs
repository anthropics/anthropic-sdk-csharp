...
using WebSearchToolResultBlockParamContentVariants = Anthropic.Beta.Client.Models.Messages.WebSearchToolResultBlockParamContentVariants;

namespace Anthropic.Beta.Client.Models.Messages;
