...
using ContentVariants = Anthropic.Beta.Client.Models.Messages.MessageParamProperties.ContentVariants;

namespace Anthropic.Beta.Client.Models.Messages.MessageParamProperties;
