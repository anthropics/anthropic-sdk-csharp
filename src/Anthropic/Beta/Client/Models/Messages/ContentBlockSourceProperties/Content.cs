...
using ContentVariants = Anthropic.Beta.Client.Models.Messages.ContentBlockSourceProperties.ContentVariants;

namespace Anthropic.Beta.Client.Models.Messages.ContentBlockSourceProperties;
