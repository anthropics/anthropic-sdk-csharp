...
using SystemVariants = Anthropic.Beta.Client.Models.Messages.MessageCountTokensParamsProperties.SystemVariants;

namespace Anthropic.Beta.Client.Models.Messages.MessageCountTokensParamsProperties;
