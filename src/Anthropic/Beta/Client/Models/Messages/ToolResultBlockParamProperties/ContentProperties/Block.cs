...
using BlockVariants = Anthropic.Beta.Client.Models.Messages.ToolResultBlockParamProperties.ContentProperties.BlockVariants;

namespace Anthropic.Beta.Client.Models.Messages.ToolResultBlockParamProperties.ContentProperties;
