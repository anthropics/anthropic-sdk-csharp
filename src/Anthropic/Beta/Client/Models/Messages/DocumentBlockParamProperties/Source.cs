...
using SourceVariants = Anthropic.Beta.Client.Models.Messages.DocumentBlockParamProperties.SourceVariants;

namespace Anthropic.Beta.Client.Models.Messages.DocumentBlockParamProperties;
