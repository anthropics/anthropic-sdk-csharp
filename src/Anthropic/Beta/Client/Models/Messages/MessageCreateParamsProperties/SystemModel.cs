...
using SystemVariants = Anthropic.Beta.Client.Models.Messages.MessageCreateParamsProperties.SystemVariants;

namespace Anthropic.Beta.Client.Models.Messages.MessageCreateParamsProperties;
