...
using Anthropic.Beta.Client.Models.Beta.Messages.Batches.BatchCreateParamsProperties.RequestProperties.ParamsProperties;
using Anthropic.Beta.Client.Models.Beta.Messages.BetaCacheControlEphemeralProperties;
using Anthropic.Beta.Client.Models.Beta.Messages.BetaMessageParamProperties;
using Anthropic.Beta.Client.Models.Beta.Messages.BetaToolProperties;
using Messages = Anthropic.Beta.Client.Models.Messages;

namespace Anthropic.Beta.Client.Tests.Services.Beta.Messages.Batches;
