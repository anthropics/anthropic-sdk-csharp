...
using Anthropic.Beta.Client.Models.Messages.Batches.BatchCreateParamsProperties.RequestProperties.ParamsProperties;
...
namespace Anthropic.Beta.Client.Tests.Services.Messages.Batches;
