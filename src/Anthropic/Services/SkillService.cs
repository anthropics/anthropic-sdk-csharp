...
public sealed class SkillService : ISkillService
{
    ...
    /// <inheritdoc/>
    public async Task<Skill> Create(
    ...
    /// <inheritdoc/>
    public async Task<Skill> Retrieve(
    ...
    /// <inheritdoc/>
    public async Task<DeletedSkill> Delete(
    ...
    /// <inheritdoc/>
    public Task<DeletedSkill> Delete(
        string skillID,
...
public sealed class SkillServiceWithRawResponse : ISkillServiceWithRawResponse
{
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<Skill>> Create(
        SkillCreateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            async (token) =>
            {
                var skill = await response.Deserialize<Skill>(token).ConfigureAwait(false);
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<Skill>> Retrieve(
        SkillRetrieveParams parameters,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<Skill>> Retrieve(
        string skillID,
        SkillRetrieveParams? parameters = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<DeletedSkill>> Delete(
        SkillDeleteParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            async (token) =>
            {
                var deletedSkill = await response
                    .Deserialize<DeletedSkill>(token)
                    .ConfigureAwait(false);
                if (this._client.ResponseValidation)
                {
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<DeletedSkill>> Delete(
        string skillID,
        SkillDeleteParams? parameters = null,
        CancellationToken cancellationToken = default
    )
