...
public abstract record class ModelBase
{
    ...
    internal static readonly JsonSerializerOptions SerializerOptions = new()
    {
        Converters =
        {
            ...
            new ApiEnumConverter<string, ToolUnionCodeExecutionTool20260120AllowedCaller>(),
            new ApiEnumConverter<string, ToolUnionWebSearchTool20260209AllowedCaller>(),
            new ApiEnumConverter<string, ToolUnionWebFetchTool20260209AllowedCaller>(),
            new ApiEnumConverter<string, UsageServiceTier>(),
            new ApiEnumConverter<string, UsageSpeed>(),
