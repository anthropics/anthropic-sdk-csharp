...
public class BrowserStateChangeDownloadCompletedTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserStateChangeDownloadCompleted
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserStateChangeDownloadCompleted>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserStateChangeDownloadCompleted copied = new(model);
