...
public class BrowserReadNetworkConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserReadNetworkConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserReadNetworkConfig>(
            json,
    ...
    {
        var model = new BrowserReadNetworkConfig { };
    ...
    {
        var model = new BrowserReadNetworkConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserReadNetworkConfig copied = new(model);
