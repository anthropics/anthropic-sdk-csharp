...
public class ComputerRightClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerRightClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerRightClickConfig>(
            json,
    ...
    {
        var model = new ComputerRightClickConfig { };
    ...
    {
        var model = new ComputerRightClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerRightClickConfig copied = new(model);
