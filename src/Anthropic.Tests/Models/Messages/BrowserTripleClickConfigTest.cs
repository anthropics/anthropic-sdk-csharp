...
public class BrowserTripleClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserTripleClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserTripleClickConfig>(
            json,
    ...
    {
        var model = new BrowserTripleClickConfig { };
    ...
    {
        var model = new BrowserTripleClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserTripleClickConfig copied = new(model);
