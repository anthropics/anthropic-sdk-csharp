...
public class BrowserCloseTabConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserCloseTabConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserCloseTabConfig>(
            json,
    ...
    {
        var model = new BrowserCloseTabConfig { };
    ...
    {
        var model = new BrowserCloseTabConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserCloseTabConfig copied = new(model);
