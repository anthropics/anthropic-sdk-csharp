...
public class ComputerMouseMoveConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerMouseMoveConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerMouseMoveConfig>(
            json,
    ...
    {
        var model = new ComputerMouseMoveConfig { };
    ...
    {
        var model = new ComputerMouseMoveConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerMouseMoveConfig copied = new(model);
