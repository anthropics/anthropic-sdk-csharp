...
public class ComputerLeftMouseDownConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerLeftMouseDownConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerLeftMouseDownConfig>(
            json,
    ...
    {
        var model = new ComputerLeftMouseDownConfig { };
    ...
    {
        var model = new ComputerLeftMouseDownConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerLeftMouseDownConfig copied = new(model);
