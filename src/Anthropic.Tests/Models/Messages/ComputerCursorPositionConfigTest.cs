...
public class ComputerCursorPositionConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerCursorPositionConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerCursorPositionConfig>(
            json,
    ...
    {
        var model = new ComputerCursorPositionConfig { };
    ...
    {
        var model = new ComputerCursorPositionConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerCursorPositionConfig copied = new(model);
