...
public class BrowserSwitchTabConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserSwitchTabConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserSwitchTabConfig>(
            json,
    ...
    {
        var model = new BrowserSwitchTabConfig { };
    ...
    {
        var model = new BrowserSwitchTabConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserSwitchTabConfig copied = new(model);
