...
public class BrowserLeftMouseUpConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserLeftMouseUpConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserLeftMouseUpConfig>(
            json,
    ...
    {
        var model = new BrowserLeftMouseUpConfig { };
    ...
    {
        var model = new BrowserLeftMouseUpConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserLeftMouseUpConfig copied = new(model);
