...
public class BrowserReadPageConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserReadPageConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserReadPageConfig>(
            json,
    ...
    {
        var model = new BrowserReadPageConfig { };
    ...
    {
        var model = new BrowserReadPageConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserReadPageConfig copied = new(model);
