...
public class BrowserLeftClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserLeftClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserLeftClickConfig>(
            json,
    ...
    {
        var model = new BrowserLeftClickConfig { };
    ...
    {
        var model = new BrowserLeftClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserLeftClickConfig copied = new(model);
