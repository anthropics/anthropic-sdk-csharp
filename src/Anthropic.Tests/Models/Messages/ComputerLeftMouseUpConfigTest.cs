...
public class ComputerLeftMouseUpConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerLeftMouseUpConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerLeftMouseUpConfig>(
            json,
    ...
    {
        var model = new ComputerLeftMouseUpConfig { };
    ...
    {
        var model = new ComputerLeftMouseUpConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerLeftMouseUpConfig copied = new(model);
