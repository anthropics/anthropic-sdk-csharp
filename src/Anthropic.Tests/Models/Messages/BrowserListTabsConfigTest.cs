...
public class BrowserListTabsConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserListTabsConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserListTabsConfig>(
            json,
    ...
    {
        var model = new BrowserListTabsConfig { };
    ...
    {
        var model = new BrowserListTabsConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserListTabsConfig copied = new(model);
