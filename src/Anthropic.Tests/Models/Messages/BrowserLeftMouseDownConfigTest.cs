...
public class BrowserLeftMouseDownConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserLeftMouseDownConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserLeftMouseDownConfig>(
            json,
    ...
    {
        var model = new BrowserLeftMouseDownConfig { };
    ...
    {
        var model = new BrowserLeftMouseDownConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserLeftMouseDownConfig copied = new(model);
