...
public class WebFetchToolResultBlockCallerTest : TestBase
{
    ...
    public void CodeExecution20260120ValidationWorks()
    {
        WebFetchToolResultBlockCaller value =
            new WebFetchToolResultBlockCallerCodeExecution20260120("srvtoolu_SQfNkl1n_JR_");
        value.Validate();
    }
...
public class WebFetchToolResultBlockCallerCodeExecution20260120Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new WebFetchToolResultBlockCallerCodeExecution20260120
        {
    ...
    public void CopyConstructor_Works()
    {
        ...
        WebFetchToolResultBlockCallerCodeExecution20260120 copied = new(model);
