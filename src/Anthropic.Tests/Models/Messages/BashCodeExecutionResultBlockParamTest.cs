...
public class BashCodeExecutionResultBlockParamTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BashCodeExecutionResultBlockParam
        {
            Content = [new("file_id")],
            ReturnCode = 0,
            Stderr = "stderr",
        ...
        List<BashCodeExecutionOutputBlockParam> expectedContent = [new("file_id")];
    ...
    public void CopyConstructor_Works()
    {
        ...
        BashCodeExecutionResultBlockParam copied = new(model);
