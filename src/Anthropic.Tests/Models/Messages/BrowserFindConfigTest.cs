...
public class BrowserFindConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserFindConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserFindConfig>(
            json,
    ...
    {
        var model = new BrowserFindConfig { };
    ...
    {
        var model = new BrowserFindConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserFindConfig copied = new(model);
