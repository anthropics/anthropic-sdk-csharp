...
public class BrowserJavascriptExecConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserJavascriptExecConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserJavascriptExecConfig>(
            json,
    ...
    {
        var model = new BrowserJavascriptExecConfig { };
    ...
    {
        var model = new BrowserJavascriptExecConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserJavascriptExecConfig copied = new(model);
