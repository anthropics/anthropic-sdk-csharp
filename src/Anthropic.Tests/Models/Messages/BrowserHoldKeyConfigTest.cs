...
public class BrowserHoldKeyConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserHoldKeyConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserHoldKeyConfig>(
            json,
    ...
    {
        var model = new BrowserHoldKeyConfig { };
    ...
    {
        var model = new BrowserHoldKeyConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserHoldKeyConfig copied = new(model);
