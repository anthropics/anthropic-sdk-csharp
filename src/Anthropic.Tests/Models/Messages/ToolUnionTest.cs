...
public class ToolUnionTest : TestBase
{
    ...
    {
        ToolUnion value = new ToolUnionCodeExecutionTool20260120()
        {
            AllowedCallers = [ToolUnionCodeExecutionTool20260120AllowedCaller.Direct],
            CacheControl = new() { Ttl = Ttl.Ttl5m },
            DeferLoading = true,
            Strict = true,
        };
    ...
    {
        ToolUnion value = new ToolUnionWebSearchTool20260209()
        {
            AllowedCallers = [ToolUnionWebSearchTool20260209AllowedCaller.Direct],
            AllowedDomains = ["string"],
            BlockedDomains = ["string"],
            CacheControl = new() { Ttl = Ttl.Ttl5m },
            DeferLoading = true,
    ...
    {
        ToolUnion value = new ToolUnionWebFetchTool20260209()
        {
            AllowedCallers = [ToolUnionWebFetchTool20260209AllowedCaller.Direct],
            AllowedDomains = ["string"],
            BlockedDomains = ["string"],
            CacheControl = new() { Ttl = Ttl.Ttl5m },
            Citations = new() { Enabled = true },
...
public class ToolUnionCodeExecutionTool20260120Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ToolUnionCodeExecutionTool20260120
        {
            AllowedCallers = [ToolUnionCodeExecutionTool20260120AllowedCaller.Direct],
            CacheControl = new() { Ttl = Ttl.Ttl5m },
            DeferLoading = true,
        ...
        > expectedAllowedCallers = [ToolUnionCodeExecutionTool20260120AllowedCaller.Direct];
    ...
    public void CopyConstructor_Works()
    {
        ...
        ToolUnionCodeExecutionTool20260120 copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ToolUnionCodeExecutionTool20260120AllowedCallerTest : TestBase
{
    [Theory]
    [InlineData(ToolUnionCodeExecutionTool20260120AllowedCaller.Direct)]
    [InlineData(ToolUnionCodeExecutionTool20260120AllowedCaller.CodeExecution20250825)]
    public void Validation_Works(ToolUnionCodeExecutionTool20260120AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ToolUnionCodeExecutionTool20260120AllowedCaller> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(ToolUnionCodeExecutionTool20260120AllowedCaller.CodeExecution20250825)]
    public void SerializationRoundtrip_Works(
        ToolUnionCodeExecutionTool20260120AllowedCaller rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ToolUnionCodeExecutionTool20260120AllowedCaller> value = rawValue;
...
public class ToolUnionWebSearchTool20260209Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ToolUnionWebSearchTool20260209
        {
            AllowedCallers = [ToolUnionWebSearchTool20260209AllowedCaller.Direct],
            AllowedDomains = ["string"],
            BlockedDomains = ["string"],
        ...
        List<ApiEnum<string, ToolUnionWebSearchTool20260209AllowedCaller>> expectedAllowedCallers =
        [
            ToolUnionWebSearchTool20260209AllowedCaller.Direct,
        ];
        ...
        bool expectedStrict = true;
        ToolUnionWebSearchTool20260209UserLocation expectedUserLocation = new()
        {
            City = "New York",
            Country = "US",
            Region = "California",
    ...
    public void CopyConstructor_Works()
    {
        ...
        ToolUnionWebSearchTool20260209 copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ToolUnionWebSearchTool20260209AllowedCallerTest : TestBase
{
    [Theory]
    [InlineData(ToolUnionWebSearchTool20260209AllowedCaller.Direct)]
    [InlineData(ToolUnionWebSearchTool20260209AllowedCaller.CodeExecution20250825)]
    public void Validation_Works(ToolUnionWebSearchTool20260209AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ToolUnionWebSearchTool20260209AllowedCaller> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(ToolUnionWebSearchTool20260209AllowedCaller.Direct)]
    [InlineData(ToolUnionWebSearchTool20260209AllowedCaller.CodeExecution20250825)]
    public void SerializationRoundtrip_Works(ToolUnionWebSearchTool20260209AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ToolUnionWebSearchTool20260209AllowedCaller> value = rawValue;
...
public class ToolUnionWebSearchTool20260209UserLocationTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ToolUnionWebSearchTool20260209UserLocation
        {
            City = "New York",
            Country = "US",
            Region = "California",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ToolUnionWebSearchTool20260209UserLocation>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ToolUnionWebSearchTool20260209UserLocation copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ToolUnionWebFetchTool20260209Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ToolUnionWebFetchTool20260209
        {
            AllowedCallers = [ToolUnionWebFetchTool20260209AllowedCaller.Direct],
            AllowedDomains = ["string"],
            BlockedDomains = ["string"],
        ...
        List<ApiEnum<string, ToolUnionWebFetchTool20260209AllowedCaller>> expectedAllowedCallers =
        [
            ToolUnionWebFetchTool20260209AllowedCaller.Direct,
        ];
        List<string> expectedAllowedDomains = ["string"];
        List<string> expectedBlockedDomains = ["string"];
        CacheControlEphemeral expectedCacheControl = new() { Ttl = Ttl.Ttl5m };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ToolUnionWebFetchTool20260209 copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ToolUnionWebFetchTool20260209AllowedCallerTest : TestBase
{
    [Theory]
    [InlineData(ToolUnionWebFetchTool20260209AllowedCaller.Direct)]
    [InlineData(ToolUnionWebFetchTool20260209AllowedCaller.CodeExecution20250825)]
    public void Validation_Works(ToolUnionWebFetchTool20260209AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ToolUnionWebFetchTool20260209AllowedCaller> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(ToolUnionWebFetchTool20260209AllowedCaller.Direct)]
    [InlineData(ToolUnionWebFetchTool20260209AllowedCaller.CodeExecution20250825)]
    public void SerializationRoundtrip_Works(ToolUnionWebFetchTool20260209AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ToolUnionWebFetchTool20260209AllowedCaller> value = rawValue;
