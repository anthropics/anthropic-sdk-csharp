...
public class ComputerScrollConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerScrollConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerScrollConfig>(
            json,
    ...
    {
        var model = new ComputerScrollConfig { };
    ...
    {
        var model = new ComputerScrollConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerScrollConfig copied = new(model);
