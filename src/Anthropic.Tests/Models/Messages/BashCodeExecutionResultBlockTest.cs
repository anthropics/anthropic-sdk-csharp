...
public class BashCodeExecutionResultBlockTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BashCodeExecutionResultBlock
        {
            Content = [new("file_id")],
            ReturnCode = 0,
            Stderr = "stderr",
        ...
        List<BashCodeExecutionOutputBlock> expectedContent = [new("file_id")];
    ...
    public void CopyConstructor_Works()
    {
        ...
        BashCodeExecutionResultBlock copied = new(model);
