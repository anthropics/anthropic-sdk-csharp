...
public class BrowserDoubleClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserDoubleClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserDoubleClickConfig>(
            json,
    ...
    {
        var model = new BrowserDoubleClickConfig { };
    ...
    {
        var model = new BrowserDoubleClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserDoubleClickConfig copied = new(model);
