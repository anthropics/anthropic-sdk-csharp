...
public class ComputerMiddleClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerMiddleClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerMiddleClickConfig>(
            json,
    ...
    {
        var model = new ComputerMiddleClickConfig { };
    ...
    {
        var model = new ComputerMiddleClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerMiddleClickConfig copied = new(model);
