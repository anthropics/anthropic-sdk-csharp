...
public class ComputerLeftClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerLeftClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerLeftClickConfig>(
            json,
    ...
    {
        var model = new ComputerLeftClickConfig { };
    ...
    {
        var model = new ComputerLeftClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerLeftClickConfig copied = new(model);
