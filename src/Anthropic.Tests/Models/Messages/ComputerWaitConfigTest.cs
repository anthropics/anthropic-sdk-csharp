...
public class ComputerWaitConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerWaitConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerWaitConfig>(
            json,
    ...
    {
        var model = new ComputerWaitConfig { };
    ...
    {
        var model = new ComputerWaitConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerWaitConfig copied = new(model);
