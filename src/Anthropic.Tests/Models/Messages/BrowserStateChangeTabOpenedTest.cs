...
public class BrowserStateChangeTabOpenedTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserStateChangeTabOpened { TabID = "tab_id" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserStateChangeTabOpened copied = new(model);
