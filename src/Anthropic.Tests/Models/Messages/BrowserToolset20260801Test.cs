...
public class BrowserToolset20260801Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserToolset20260801
        {
        ...
        List<ApiEnum<string, BrowserToolset20260801AllowedCaller>> expectedAllowedCallers =
        [
            BrowserToolset20260801AllowedCaller.Direct,
        ];
        CacheControlEphemeral expectedCacheControl = new() { Ttl = Ttl.Ttl5m };
        BrowserToolsetConfigs expectedConfigs = new()
        {
            CloseTab = new() { DeferLoading = true, Enabled = true },
            DoubleClick = new() { DeferLoading = true, Enabled = true },
            FileUpload = new() { DeferLoading = true, Enabled = true },
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserToolset20260801>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserToolset20260801 copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class BrowserToolset20260801AllowedCallerTest : TestBase
{
    [Theory]
    [InlineData(BrowserToolset20260801AllowedCaller.Direct)]
    [InlineData(BrowserToolset20260801AllowedCaller.CodeExecution20250825)]
    [InlineData(BrowserToolset20260801AllowedCaller.CodeExecution20260120)]
    [InlineData(BrowserToolset20260801AllowedCaller.CodeExecution20260521)]
    public void Validation_Works(BrowserToolset20260801AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BrowserToolset20260801AllowedCaller> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(BrowserToolset20260801AllowedCaller.CodeExecution20260120)]
    [InlineData(BrowserToolset20260801AllowedCaller.CodeExecution20260521)]
    public void SerializationRoundtrip_Works(BrowserToolset20260801AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BrowserToolset20260801AllowedCaller> value = rawValue;
