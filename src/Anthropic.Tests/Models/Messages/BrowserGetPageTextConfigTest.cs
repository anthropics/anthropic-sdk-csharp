...
public class BrowserGetPageTextConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserGetPageTextConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserGetPageTextConfig>(
            json,
    ...
    {
        var model = new BrowserGetPageTextConfig { };
    ...
    {
        var model = new BrowserGetPageTextConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserGetPageTextConfig copied = new(model);
