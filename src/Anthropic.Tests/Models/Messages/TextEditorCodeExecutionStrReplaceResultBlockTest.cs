...
public class TextEditorCodeExecutionStrReplaceResultBlockTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TextEditorCodeExecutionStrReplaceResultBlock
        {
            Lines = ["string"],
            NewLines = 0,
            NewStart = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<TextEditorCodeExecutionStrReplaceResultBlock>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        TextEditorCodeExecutionStrReplaceResultBlock copied = new(model);
