...
public class BrowserReadConsoleConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserReadConsoleConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserReadConsoleConfig>(
            json,
    ...
    {
        var model = new BrowserReadConsoleConfig { };
    ...
    {
        var model = new BrowserReadConsoleConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserReadConsoleConfig copied = new(model);
