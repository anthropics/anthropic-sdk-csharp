...
public class WebSearchTool20260318Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        List<ApiEnum<string, WebSearchTool20260318AllowedCaller>> expectedAllowedCallers =
        [
            WebSearchTool20260318AllowedCaller.Direct,
        ];
        ...
        ApiEnum<string, WebSearchTool20260318ResponseInclusion> expectedResponseInclusion =
            WebSearchTool20260318ResponseInclusion.Full;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<WebSearchTool20260318>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        WebSearchTool20260318 copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class WebSearchTool20260318AllowedCallerTest : TestBase
{
    [Theory]
    [InlineData(WebSearchTool20260318AllowedCaller.Direct)]
    [InlineData(WebSearchTool20260318AllowedCaller.CodeExecution20250825)]
    [InlineData(WebSearchTool20260318AllowedCaller.CodeExecution20260120)]
    [InlineData(WebSearchTool20260318AllowedCaller.CodeExecution20260521)]
    public void Validation_Works(WebSearchTool20260318AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WebSearchTool20260318AllowedCaller> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, WebSearchTool20260318AllowedCaller>>(
    ...
    [InlineData(WebSearchTool20260318AllowedCaller.CodeExecution20260120)]
    [InlineData(WebSearchTool20260318AllowedCaller.CodeExecution20260521)]
    public void SerializationRoundtrip_Works(WebSearchTool20260318AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WebSearchTool20260318AllowedCaller> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, WebSearchTool20260318AllowedCaller>
...
public class WebSearchTool20260318ResponseInclusionTest : TestBase
{
    [Theory]
    [InlineData(WebSearchTool20260318ResponseInclusion.Full)]
    [InlineData(WebSearchTool20260318ResponseInclusion.Excluded)]
    public void Validation_Works(WebSearchTool20260318ResponseInclusion rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WebSearchTool20260318ResponseInclusion> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(WebSearchTool20260318ResponseInclusion.Full)]
    [InlineData(WebSearchTool20260318ResponseInclusion.Excluded)]
    public void SerializationRoundtrip_Works(WebSearchTool20260318ResponseInclusion rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WebSearchTool20260318ResponseInclusion> value = rawValue;
