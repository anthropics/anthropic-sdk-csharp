...
public class BrowserFormInputConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserFormInputConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserFormInputConfig>(
            json,
    ...
    {
        var model = new BrowserFormInputConfig { };
    ...
    {
        var model = new BrowserFormInputConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserFormInputConfig copied = new(model);
