...
public class ComputerTripleClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerTripleClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerTripleClickConfig>(
            json,
    ...
    {
        var model = new ComputerTripleClickConfig { };
    ...
    {
        var model = new ComputerTripleClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerTripleClickConfig copied = new(model);
