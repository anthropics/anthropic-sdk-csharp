...
public class BrowserTypeConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserTypeConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserTypeConfig>(
            json,
    ...
    {
        var model = new BrowserTypeConfig { };
    ...
    {
        var model = new BrowserTypeConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserTypeConfig copied = new(model);
