...
public class BrowserHoverConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserHoverConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserHoverConfig>(
            json,
    ...
    {
        var model = new BrowserHoverConfig { };
    ...
    {
        var model = new BrowserHoverConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserHoverConfig copied = new(model);
