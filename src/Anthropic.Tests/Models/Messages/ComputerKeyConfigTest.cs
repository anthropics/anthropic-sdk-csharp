...
public class ComputerKeyConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerKeyConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerKeyConfig>(
            json,
    ...
    {
        var model = new ComputerKeyConfig { };
    ...
    {
        var model = new ComputerKeyConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerKeyConfig copied = new(model);
