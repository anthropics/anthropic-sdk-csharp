...
public class ComputerLeftClickDragConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerLeftClickDragConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerLeftClickDragConfig>(
            json,
    ...
    {
        var model = new ComputerLeftClickDragConfig { };
    ...
    {
        var model = new ComputerLeftClickDragConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerLeftClickDragConfig copied = new(model);
