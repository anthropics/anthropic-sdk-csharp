...
public class ComputerTypeConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerTypeConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerTypeConfig>(
            json,
    ...
    {
        var model = new ComputerTypeConfig { };
    ...
    {
        var model = new ComputerTypeConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerTypeConfig copied = new(model);
