...
public class BrowserMouseMoveConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserMouseMoveConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserMouseMoveConfig>(
            json,
    ...
    {
        var model = new BrowserMouseMoveConfig { };
    ...
    {
        var model = new BrowserMouseMoveConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserMouseMoveConfig copied = new(model);
