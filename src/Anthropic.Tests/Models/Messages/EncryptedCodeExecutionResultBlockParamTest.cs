...
public class EncryptedCodeExecutionResultBlockParamTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EncryptedCodeExecutionResultBlockParam
        {
            Content = [new("file_id")],
    ...
    public void CopyConstructor_Works()
    {
        ...
        EncryptedCodeExecutionResultBlockParam copied = new(model);
