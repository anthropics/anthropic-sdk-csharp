...
public class ComputerZoomConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerZoomConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerZoomConfig>(
            json,
    ...
    {
        var model = new ComputerZoomConfig { };
    ...
    {
        var model = new ComputerZoomConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerZoomConfig copied = new(model);
