...
public class BrowserWaitConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserWaitConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserWaitConfig>(
            json,
    ...
    {
        var model = new BrowserWaitConfig { };
    ...
    {
        var model = new BrowserWaitConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserWaitConfig copied = new(model);
