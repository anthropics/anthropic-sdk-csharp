...
public class BrowserFileUploadConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserFileUploadConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserFileUploadConfig>(
            json,
    ...
    {
        var model = new BrowserFileUploadConfig { };
    ...
    {
        var model = new BrowserFileUploadConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserFileUploadConfig copied = new(model);
