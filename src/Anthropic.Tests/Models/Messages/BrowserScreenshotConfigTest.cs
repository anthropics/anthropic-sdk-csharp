...
public class BrowserScreenshotConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserScreenshotConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserScreenshotConfig>(
            json,
    ...
    {
        var model = new BrowserScreenshotConfig { };
    ...
    {
        var model = new BrowserScreenshotConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserScreenshotConfig copied = new(model);
