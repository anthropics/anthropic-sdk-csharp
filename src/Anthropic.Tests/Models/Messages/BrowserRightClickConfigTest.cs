...
public class BrowserRightClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserRightClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserRightClickConfig>(
            json,
    ...
    {
        var model = new BrowserRightClickConfig { };
    ...
    {
        var model = new BrowserRightClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserRightClickConfig copied = new(model);
