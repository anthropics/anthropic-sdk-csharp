...
public class ComputerDoubleClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerDoubleClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerDoubleClickConfig>(
            json,
    ...
    {
        var model = new ComputerDoubleClickConfig { };
    ...
    {
        var model = new ComputerDoubleClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerDoubleClickConfig copied = new(model);
