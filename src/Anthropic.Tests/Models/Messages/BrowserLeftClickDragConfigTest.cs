...
public class BrowserLeftClickDragConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserLeftClickDragConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserLeftClickDragConfig>(
            json,
    ...
    {
        var model = new BrowserLeftClickDragConfig { };
    ...
    {
        var model = new BrowserLeftClickDragConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserLeftClickDragConfig copied = new(model);
