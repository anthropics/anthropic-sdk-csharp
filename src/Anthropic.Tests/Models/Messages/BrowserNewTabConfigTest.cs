...
public class BrowserNewTabConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserNewTabConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserNewTabConfig>(
            json,
    ...
    {
        var model = new BrowserNewTabConfig { };
    ...
    {
        var model = new BrowserNewTabConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserNewTabConfig copied = new(model);
