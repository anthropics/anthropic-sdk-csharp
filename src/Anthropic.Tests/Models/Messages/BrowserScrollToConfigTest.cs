...
public class BrowserScrollToConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserScrollToConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserScrollToConfig>(
            json,
    ...
    {
        var model = new BrowserScrollToConfig { };
    ...
    {
        var model = new BrowserScrollToConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserScrollToConfig copied = new(model);
