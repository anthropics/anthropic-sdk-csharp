...
public class BrowserStateBlockParamTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserStateBlockParam
        {
            Tabs =
            [
                new()
            ...
            StateChanges = [new BrowserStateChangeTabOpened("tab_id")],
        };

        List<BrowserStateTabEntry> expectedTabs =
        [
            new()
            {
                TabID = "tab_id",
        ...
        List<BrowserStateChange> expectedStateChanges = [new BrowserStateChangeTabOpened("tab_id")];
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserStateBlockParam copied = new(model);
