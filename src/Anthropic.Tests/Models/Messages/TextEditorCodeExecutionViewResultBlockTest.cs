...
public class TextEditorCodeExecutionViewResultBlockTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TextEditorCodeExecutionViewResultBlock
        {
            Content = "content",
    ...
    public void CopyConstructor_Works()
    {
        ...
        TextEditorCodeExecutionViewResultBlock copied = new(model);
