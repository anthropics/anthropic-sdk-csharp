...
public class BrowserZoomConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserZoomConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserZoomConfig>(
            json,
    ...
    {
        var model = new BrowserZoomConfig { };
    ...
    {
        var model = new BrowserZoomConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserZoomConfig copied = new(model);
