...
public class ComputerHoldKeyConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerHoldKeyConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerHoldKeyConfig>(
            json,
    ...
    {
        var model = new ComputerHoldKeyConfig { };
    ...
    {
        var model = new ComputerHoldKeyConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerHoldKeyConfig copied = new(model);
