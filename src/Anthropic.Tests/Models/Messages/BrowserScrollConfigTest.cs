...
public class BrowserScrollConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserScrollConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserScrollConfig>(
            json,
    ...
    {
        var model = new BrowserScrollConfig { };
    ...
    {
        var model = new BrowserScrollConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserScrollConfig copied = new(model);
