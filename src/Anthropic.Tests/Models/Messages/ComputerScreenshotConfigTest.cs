...
public class ComputerScreenshotConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ComputerScreenshotConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ComputerScreenshotConfig>(
            json,
    ...
    {
        var model = new ComputerScreenshotConfig { };
    ...
    {
        var model = new ComputerScreenshotConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ComputerScreenshotConfig copied = new(model);
