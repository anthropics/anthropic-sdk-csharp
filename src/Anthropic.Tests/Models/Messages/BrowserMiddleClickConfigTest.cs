...
public class BrowserMiddleClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrowserMiddleClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrowserMiddleClickConfig>(
            json,
    ...
    {
        var model = new BrowserMiddleClickConfig { };
    ...
    {
        var model = new BrowserMiddleClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrowserMiddleClickConfig copied = new(model);
