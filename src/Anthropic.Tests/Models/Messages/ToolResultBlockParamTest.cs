...
public class BlockTest : TestBase
{
    ...
    [Fact]
    public void BrowserStateBlockParamValidationWorks()
    {
        Block value = new BrowserStateBlockParam()
        {
            Tabs =
            [
                new()
    ...
    [Fact]
    public void BrowserStateBlockParamSerializationRoundtripWorks()
    {
        Block value = new BrowserStateBlockParam()
        {
            Tabs =
    ...
    public void UnknownVariantCommonProperties_Works()
    {
        ...
        Block emptyValue = new(JsonSerializer.Deserialize<JsonElement>("{}"));

        Assert.Throws<AnthropicInvalidDataException>(() => emptyValue.Type);
        Assert.Null(emptyValue.CacheControl);
        Assert.Null(emptyValue.Title);

        Block mismatchedValue = new(
            JsonSerializer.Deserialize<JsonElement>(
                """
                {
                  "cache_control": [
