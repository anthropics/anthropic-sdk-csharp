...
public class ResourceListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ResourceListParams
        {
    ...
    {
        var parameters = new ResourceListParams { SessionID = "sesn_011CZkZAtmR3yMPDzynEDxu7" };
    ...
    public void Url_Works()
    {
        ...
        Assert.Equal(
            new Uri(
                "https://api.anthropic.com/v1/sessions/sesn_011CZkZAtmR3yMPDzynEDxu7/resources?beta=true&limit=0&page=page"
            ),
            url
        );
    }
