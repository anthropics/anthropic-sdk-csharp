...
public class BetaManagedAgentsSessionResourceTest : TestBase
{
    ...
    {
        BetaManagedAgentsSessionResource value = new BetaManagedAgentsMemoryStoreResource()
        {
    ...
    {
        BetaManagedAgentsSessionResource value = new(
        ...
        BetaManagedAgentsSessionResource emptyValue = new(
            JsonSerializer.Deserialize<JsonElement>("{}")
        );
        ...
        BetaManagedAgentsSessionResource mismatchedValue = new(
            JsonSerializer.Deserialize<JsonElement>(
                """
                {
                  "id": [
