...
public class BetaManagedAgentsSessionUsageSnapshotTest : TestBase
{
    [Fact]
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaManagedAgentsSessionUsageSnapshot>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaManagedAgentsSessionUsageSnapshot copied = new(model);
