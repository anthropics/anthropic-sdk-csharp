...
public class EventStreamParamsTest : TestBase
{
    ...
    {
        EventStreamParams parameters = new() { SessionID = "sesn_011CZkZAtmR3yMPDzynEDxu7" };

        var url = parameters.Url(new() { ApiKey = "my-anthropic-api-key" });

        Assert.Equal(
            new Uri(
                "https://api.anthropic.com/v1/sessions/sesn_011CZkZAtmR3yMPDzynEDxu7/events/stream?beta=true"
            ),
            url
        );
    }
