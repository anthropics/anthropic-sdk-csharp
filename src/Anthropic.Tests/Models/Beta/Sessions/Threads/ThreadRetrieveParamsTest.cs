...
public class ThreadRetrieveParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ThreadRetrieveParams
        {
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.anthropic.com/v1/sessions/sesn_011CZkZAtmR3yMPDzynEDxu7/threads/sthr_011CZkZVWa6oIjw0rgXZpnBt?beta=true"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ThreadRetrieveParams copied = new(parameters);
