...
public class SessionDeleteParamsTest : TestBase
{
    [Fact]
    ...
    {
        var parameters = new SessionDeleteParams { SessionID = "sesn_011CZkZAtmR3yMPDzynEDxu7" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        SessionDeleteParams copied = new(parameters);
