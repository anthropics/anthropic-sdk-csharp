...
public class BetaSkillVersionTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaSkillVersion
        {
            ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaSkillVersion>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaSkillVersion copied = new(model);
