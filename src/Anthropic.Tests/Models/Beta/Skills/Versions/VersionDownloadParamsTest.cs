...
public class VersionDownloadParamsTest : TestBase
{
    ...
    {
        var parameters = new VersionDownloadParams { SkillID = "skill_id", Version = "version" };
    ...
    {
        VersionDownloadParams parameters = new() { SkillID = "skill_id", Version = "version" };
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.anthropic.com/v1/skills/skill_id/versions/version/content?beta=true"
                ),
                url
            )
        );
