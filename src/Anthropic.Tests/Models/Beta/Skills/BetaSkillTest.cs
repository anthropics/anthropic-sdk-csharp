...
public class BetaSkillTest : TestBase
{
    ...
    {
        var model = new Skills::BetaSkill
        {
        ...
        Skills::BetaSkillSource expectedSource = new(Skills::Type.Custom);
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Skills::BetaSkill>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Skills::BetaSkill copied = new(model);
