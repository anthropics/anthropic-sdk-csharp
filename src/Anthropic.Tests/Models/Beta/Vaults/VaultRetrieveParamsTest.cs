...
public class VaultRetrieveParamsTest : TestBase
{
    ...
    {
        var parameters = new VaultRetrieveParams
        {
    ...
    {
        var parameters = new VaultRetrieveParams { VaultID = "vlt_011CZkZDLs7fYzm1hXNPeRjv" };
    ...
    {
        VaultRetrieveParams parameters = new() { VaultID = "vlt_011CZkZDLs7fYzm1hXNPeRjv" };
