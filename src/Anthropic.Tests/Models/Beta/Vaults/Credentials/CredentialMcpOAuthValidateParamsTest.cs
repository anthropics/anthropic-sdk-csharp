...
public class CredentialMcpOAuthValidateParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new CredentialMcpOAuthValidateParams
        {
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.anthropic.com/v1/vaults/vlt_011CZkZDLs7fYzm1hXNPeRjv/credentials/vcrd_011CZkZEMt8gZan2iYOQfSkw/mcp_oauth_validate?beta=true"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CredentialMcpOAuthValidateParams copied = new(parameters);
