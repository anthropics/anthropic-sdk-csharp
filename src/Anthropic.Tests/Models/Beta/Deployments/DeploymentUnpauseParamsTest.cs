...
public class DeploymentUnpauseParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new DeploymentUnpauseParams
        {
    ...
    {
        var parameters = new DeploymentUnpauseParams { DeploymentID = "deployment_id" };
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri("https://api.anthropic.com/v1/deployments/deployment_id/unpause?beta=true"),
                url
            )
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        DeploymentUnpauseParams copied = new(parameters);
