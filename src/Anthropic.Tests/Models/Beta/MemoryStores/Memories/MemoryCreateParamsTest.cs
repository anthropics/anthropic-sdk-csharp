...
public class MemoryCreateParamsTest : TestBase
{
    ...
    {
        var parameters = new MemoryCreateParams
        {
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.anthropic.com/v1/memory_stores/memory_store_id/memories?beta=true&view=basic"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        MemoryCreateParams copied = new(parameters);
