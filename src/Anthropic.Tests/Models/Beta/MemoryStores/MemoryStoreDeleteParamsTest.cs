...
public class MemoryStoreDeleteParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new MemoryStoreDeleteParams
        {
    ...
    {
        var parameters = new MemoryStoreDeleteParams { MemoryStoreID = "memory_store_id" };
    ...
    {
        MemoryStoreDeleteParams parameters = new() { MemoryStoreID = "memory_store_id" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        MemoryStoreDeleteParams copied = new(parameters);
