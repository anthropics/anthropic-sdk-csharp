...
public class MemoryStoreArchiveParamsTest : TestBase
{
    [Fact]
    ...
    {
        var parameters = new MemoryStoreArchiveParams { MemoryStoreID = "memory_store_id" };
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.anthropic.com/v1/memory_stores/memory_store_id/archive?beta=true"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        MemoryStoreArchiveParams copied = new(parameters);
