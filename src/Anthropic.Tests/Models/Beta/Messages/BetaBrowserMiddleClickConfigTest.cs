...
public class BetaBrowserMiddleClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserMiddleClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserMiddleClickConfig>(
            json,
    ...
    {
        var model = new BetaBrowserMiddleClickConfig { };
    ...
    {
        var model = new BetaBrowserMiddleClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserMiddleClickConfig copied = new(model);
