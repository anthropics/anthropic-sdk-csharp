...
public class BetaBrowserMouseMoveConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserMouseMoveConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserMouseMoveConfig>(
            json,
    ...
    {
        var model = new BetaBrowserMouseMoveConfig { };
    ...
    {
        var model = new BetaBrowserMouseMoveConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserMouseMoveConfig copied = new(model);
