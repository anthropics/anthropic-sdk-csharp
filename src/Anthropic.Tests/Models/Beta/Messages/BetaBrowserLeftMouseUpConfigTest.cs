...
public class BetaBrowserLeftMouseUpConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserLeftMouseUpConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserLeftMouseUpConfig>(
            json,
    ...
    {
        var model = new BetaBrowserLeftMouseUpConfig { };
    ...
    {
        var model = new BetaBrowserLeftMouseUpConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserLeftMouseUpConfig copied = new(model);
