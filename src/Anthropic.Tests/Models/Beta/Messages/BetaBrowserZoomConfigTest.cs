...
public class BetaBrowserZoomConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserZoomConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserZoomConfig>(
            json,
    ...
    {
        var model = new BetaBrowserZoomConfig { };
    ...
    {
        var model = new BetaBrowserZoomConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserZoomConfig copied = new(model);
