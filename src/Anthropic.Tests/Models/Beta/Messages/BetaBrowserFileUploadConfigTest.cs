...
public class BetaBrowserFileUploadConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserFileUploadConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserFileUploadConfig>(
            json,
    ...
    {
        var model = new BetaBrowserFileUploadConfig { };
    ...
    {
        var model = new BetaBrowserFileUploadConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserFileUploadConfig copied = new(model);
