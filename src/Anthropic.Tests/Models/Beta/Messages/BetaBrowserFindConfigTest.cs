...
public class BetaBrowserFindConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserFindConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserFindConfig>(
            json,
    ...
    {
        var model = new BetaBrowserFindConfig { };
    ...
    {
        var model = new BetaBrowserFindConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserFindConfig copied = new(model);
