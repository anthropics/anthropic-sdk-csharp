...
public class BetaWebSearchToolResultBlockParamCallerTest : TestBase
{
    ...
    {
        BetaWebSearchToolResultBlockParamCaller value = new(
        ...
        BetaWebSearchToolResultBlockParamCaller emptyValue = new(
            JsonSerializer.Deserialize<JsonElement>("{}")
        );
        ...
        BetaWebSearchToolResultBlockParamCaller mismatchedValue = new(
            JsonSerializer.Deserialize<JsonElement>(
                """
                {
                  "tool_id": [
