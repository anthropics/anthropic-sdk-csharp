...
public class BetaBrowserRightClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserRightClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserRightClickConfig>(
            json,
    ...
    {
        var model = new BetaBrowserRightClickConfig { };
    ...
    {
        var model = new BetaBrowserRightClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserRightClickConfig copied = new(model);
