...
public class BetaFallbackBlockParamTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        {
            From = new(Model.ClaudeFable5_1),
            To = new(Model.ClaudeFable5_1),
            Trigger = JsonSerializer.Deserialize<JsonElement>("{}"),
        };

        BetaFallbackInfoParam expectedFrom = new(Model.ClaudeFable5_1);
        BetaFallbackInfoParam expectedTo = new(Model.ClaudeFable5_1);
