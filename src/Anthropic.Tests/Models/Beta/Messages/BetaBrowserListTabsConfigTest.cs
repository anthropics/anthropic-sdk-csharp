...
public class BetaBrowserListTabsConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserListTabsConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserListTabsConfig>(
            json,
    ...
    {
        var model = new BetaBrowserListTabsConfig { };
    ...
    {
        var model = new BetaBrowserListTabsConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserListTabsConfig copied = new(model);
