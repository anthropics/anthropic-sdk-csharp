...
public class BetaBrowserDoubleClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserDoubleClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserDoubleClickConfig>(
            json,
    ...
    {
        var model = new BetaBrowserDoubleClickConfig { };
    ...
    {
        var model = new BetaBrowserDoubleClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserDoubleClickConfig copied = new(model);
