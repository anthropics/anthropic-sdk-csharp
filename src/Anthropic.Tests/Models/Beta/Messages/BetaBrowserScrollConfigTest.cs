...
public class BetaBrowserScrollConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserScrollConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserScrollConfig>(
            json,
    ...
    {
        var model = new BetaBrowserScrollConfig { };
    ...
    {
        var model = new BetaBrowserScrollConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserScrollConfig copied = new(model);
