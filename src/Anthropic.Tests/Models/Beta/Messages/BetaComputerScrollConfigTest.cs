...
public class BetaComputerScrollConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaComputerScrollConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaComputerScrollConfig>(
            json,
    ...
    {
        var model = new BetaComputerScrollConfig { };
    ...
    {
        var model = new BetaComputerScrollConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaComputerScrollConfig copied = new(model);
