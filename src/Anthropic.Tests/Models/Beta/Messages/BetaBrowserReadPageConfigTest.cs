...
public class BetaBrowserReadPageConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserReadPageConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserReadPageConfig>(
            json,
    ...
    {
        var model = new BetaBrowserReadPageConfig { };
    ...
    {
        var model = new BetaBrowserReadPageConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserReadPageConfig copied = new(model);
