...
public class BetaComputerRightClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaComputerRightClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaComputerRightClickConfig>(
            json,
    ...
    {
        var model = new BetaComputerRightClickConfig { };
    ...
    {
        var model = new BetaComputerRightClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaComputerRightClickConfig copied = new(model);
