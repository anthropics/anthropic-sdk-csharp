...
public class BatchResultsParamsTest : TestBase
{
    [Fact]
    ...
    {
        var parameters = new BatchResultsParams { MessageBatchID = "message_batch_id" };
    ...
    public void Url_Works()
    {
        ...
        Assert.Equal(
            new Uri("https://api.anthropic.com/v1/messages/batches/message_batch_id/results"),
            url
        );
    }
