...
public class BetaComputerZoomConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaComputerZoomConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaComputerZoomConfig>(
            json,
    ...
    {
        var model = new BetaComputerZoomConfig { };
    ...
    {
        var model = new BetaComputerZoomConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaComputerZoomConfig copied = new(model);
