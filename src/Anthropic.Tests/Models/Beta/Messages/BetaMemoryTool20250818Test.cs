...
public class BetaMemoryTool20250818Test : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        {
            Name = JsonSerializer.Deserialize<JsonElement>("\"memory\""),
            Type = JsonSerializer.Deserialize<JsonElement>("\"memory_20250818\""),
            AllowedCallers = [AllowedCaller1.Direct],
        ...
        List<ApiEnum<string, AllowedCaller1>> expectedAllowedCallers = [AllowedCaller1.Direct];
