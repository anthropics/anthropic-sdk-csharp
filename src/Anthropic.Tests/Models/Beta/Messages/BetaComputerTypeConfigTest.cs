...
public class BetaComputerTypeConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaComputerTypeConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaComputerTypeConfig>(
            json,
    ...
    {
        var model = new BetaComputerTypeConfig { };
    ...
    {
        var model = new BetaComputerTypeConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaComputerTypeConfig copied = new(model);
