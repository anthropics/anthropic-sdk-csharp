...
public class BetaEncryptedCodeExecutionResultBlockTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaEncryptedCodeExecutionResultBlock
        {
            Content = [new("file_id")],
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaEncryptedCodeExecutionResultBlock copied = new(model);
