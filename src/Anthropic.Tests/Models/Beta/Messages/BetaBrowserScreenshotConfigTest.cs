...
public class BetaBrowserScreenshotConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserScreenshotConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserScreenshotConfig>(
            json,
    ...
    {
        var model = new BetaBrowserScreenshotConfig { };
    ...
    {
        var model = new BetaBrowserScreenshotConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserScreenshotConfig copied = new(model);
