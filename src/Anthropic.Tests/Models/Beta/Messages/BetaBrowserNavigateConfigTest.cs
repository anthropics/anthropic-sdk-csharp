...
public class BetaBrowserNavigateConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserNavigateConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserNavigateConfig>(
            json,
    ...
    {
        var model = new BetaBrowserNavigateConfig { };
    ...
    {
        var model = new BetaBrowserNavigateConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserNavigateConfig copied = new(model);
