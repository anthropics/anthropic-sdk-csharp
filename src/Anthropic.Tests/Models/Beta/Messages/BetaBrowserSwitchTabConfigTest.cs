...
public class BetaBrowserSwitchTabConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserSwitchTabConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserSwitchTabConfig>(
            json,
    ...
    {
        var model = new BetaBrowserSwitchTabConfig { };
    ...
    {
        var model = new BetaBrowserSwitchTabConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserSwitchTabConfig copied = new(model);
