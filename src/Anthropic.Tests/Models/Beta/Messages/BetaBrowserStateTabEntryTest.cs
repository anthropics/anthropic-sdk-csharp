...
public class BetaBrowserStateTabEntryTest : TestBase
{
    [Fact]
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserStateTabEntry>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserStateTabEntry copied = new(model);
