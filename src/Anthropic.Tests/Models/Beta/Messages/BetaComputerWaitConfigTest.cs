...
public class BetaComputerWaitConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaComputerWaitConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaComputerWaitConfig>(
            json,
    ...
    {
        var model = new BetaComputerWaitConfig { };
    ...
    {
        var model = new BetaComputerWaitConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaComputerWaitConfig copied = new(model);
