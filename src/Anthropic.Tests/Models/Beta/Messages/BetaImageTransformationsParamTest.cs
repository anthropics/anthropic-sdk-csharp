...
public class BetaImageTransformationsParamTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaImageTransformationsParam { OversizedImage = OversizedImage.Downsize };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaImageTransformationsParam>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaImageTransformationsParam copied = new(model);
