...
public class BetaBrowserGetPageTextConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserGetPageTextConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserGetPageTextConfig>(
            json,
    ...
    {
        var model = new BetaBrowserGetPageTextConfig { };
    ...
    {
        var model = new BetaBrowserGetPageTextConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserGetPageTextConfig copied = new(model);
