...
public class BetaComputerToolset20260801Test : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<ApiEnum<string, BetaComputerToolset20260801AllowedCaller>> expectedAllowedCallers =
        [
            BetaComputerToolset20260801AllowedCaller.Direct,
        ];
...
public class BetaComputerToolset20260801AllowedCallerTest : TestBase
{
    [Theory]
    [InlineData(BetaComputerToolset20260801AllowedCaller.Direct)]
    [InlineData(BetaComputerToolset20260801AllowedCaller.CodeExecution20250825)]
    [InlineData(BetaComputerToolset20260801AllowedCaller.CodeExecution20260120)]
    [InlineData(BetaComputerToolset20260801AllowedCaller.CodeExecution20260521)]
    public void Validation_Works(BetaComputerToolset20260801AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BetaComputerToolset20260801AllowedCaller> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(BetaComputerToolset20260801AllowedCaller.CodeExecution20260120)]
    [InlineData(BetaComputerToolset20260801AllowedCaller.CodeExecution20260521)]
    public void SerializationRoundtrip_Works(BetaComputerToolset20260801AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BetaComputerToolset20260801AllowedCaller> value = rawValue;
