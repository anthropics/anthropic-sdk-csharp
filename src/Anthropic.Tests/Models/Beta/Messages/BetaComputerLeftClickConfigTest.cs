...
public class BetaComputerLeftClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaComputerLeftClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaComputerLeftClickConfig>(
            json,
    ...
    {
        var model = new BetaComputerLeftClickConfig { };
    ...
    {
        var model = new BetaComputerLeftClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaComputerLeftClickConfig copied = new(model);
