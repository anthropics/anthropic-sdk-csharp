...
public class BetaComputerHoldKeyConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaComputerHoldKeyConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaComputerHoldKeyConfig>(
            json,
    ...
    {
        var model = new BetaComputerHoldKeyConfig { };
    ...
    {
        var model = new BetaComputerHoldKeyConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaComputerHoldKeyConfig copied = new(model);
