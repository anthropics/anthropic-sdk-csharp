...
public class BetaBrowserReadConsoleConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserReadConsoleConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserReadConsoleConfig>(
            json,
    ...
    {
        var model = new BetaBrowserReadConsoleConfig { };
    ...
    {
        var model = new BetaBrowserReadConsoleConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserReadConsoleConfig copied = new(model);
