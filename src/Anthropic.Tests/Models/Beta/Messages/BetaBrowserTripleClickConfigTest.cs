...
public class BetaBrowserTripleClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserTripleClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserTripleClickConfig>(
            json,
    ...
    {
        var model = new BetaBrowserTripleClickConfig { };
    ...
    {
        var model = new BetaBrowserTripleClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserTripleClickConfig copied = new(model);
