...
public class BetaEncryptedCodeExecutionResultBlockParamTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaEncryptedCodeExecutionResultBlockParam
        {
            Content = [new("file_id")],
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaEncryptedCodeExecutionResultBlockParam>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaEncryptedCodeExecutionResultBlockParam copied = new(model);
