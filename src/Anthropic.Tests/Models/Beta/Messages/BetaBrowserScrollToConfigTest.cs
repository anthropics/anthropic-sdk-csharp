...
public class BetaBrowserScrollToConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserScrollToConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserScrollToConfig>(
            json,
    ...
    {
        var model = new BetaBrowserScrollToConfig { };
    ...
    {
        var model = new BetaBrowserScrollToConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserScrollToConfig copied = new(model);
