...
public class BetaBrowserReadNetworkConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserReadNetworkConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserReadNetworkConfig>(
            json,
    ...
    {
        var model = new BetaBrowserReadNetworkConfig { };
    ...
    {
        var model = new BetaBrowserReadNetworkConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserReadNetworkConfig copied = new(model);
