...
public class BetaBrowserTypeConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserTypeConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserTypeConfig>(
            json,
    ...
    {
        var model = new BetaBrowserTypeConfig { };
    ...
    {
        var model = new BetaBrowserTypeConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserTypeConfig copied = new(model);
