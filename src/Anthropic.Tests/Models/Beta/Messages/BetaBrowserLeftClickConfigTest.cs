...
public class BetaBrowserLeftClickConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserLeftClickConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserLeftClickConfig>(
            json,
    ...
    {
        var model = new BetaBrowserLeftClickConfig { };
    ...
    {
        var model = new BetaBrowserLeftClickConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserLeftClickConfig copied = new(model);
