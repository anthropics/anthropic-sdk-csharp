...
public class BetaBrowserHoldKeyConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserHoldKeyConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserHoldKeyConfig>(
            json,
    ...
    {
        var model = new BetaBrowserHoldKeyConfig { };
    ...
    {
        var model = new BetaBrowserHoldKeyConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserHoldKeyConfig copied = new(model);
