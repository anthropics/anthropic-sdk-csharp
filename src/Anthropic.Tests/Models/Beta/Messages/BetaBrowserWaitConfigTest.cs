...
public class BetaBrowserWaitConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserWaitConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserWaitConfig>(
            json,
    ...
    {
        var model = new BetaBrowserWaitConfig { };
    ...
    {
        var model = new BetaBrowserWaitConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserWaitConfig copied = new(model);
