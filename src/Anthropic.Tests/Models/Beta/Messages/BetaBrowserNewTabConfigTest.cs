...
public class BetaBrowserNewTabConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaBrowserNewTabConfig { DeferLoading = true, Enabled = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaBrowserNewTabConfig>(
            json,
    ...
    {
        var model = new BetaBrowserNewTabConfig { };
    ...
    {
        var model = new BetaBrowserNewTabConfig { DeferLoading = null, Enabled = null };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaBrowserNewTabConfig copied = new(model);
