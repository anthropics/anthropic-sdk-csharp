...
public class CertificateArchiveParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new CertificateArchiveParams
        {
            TunnelID = "tunnel_id",
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.anthropic.com/v1/tunnels/tunnel_id/certificates/certificate_id/archive?beta=true"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CertificateArchiveParams copied = new(parameters);
