...
public class TunnelListParamsTest : TestBase
{
    [Fact]
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.anthropic.com/v1/tunnels?beta=true&include_archived=true&limit=0&page=page"
                ),
                url
            )
        );
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        TunnelListParams parameters = new() { Betas = [AnthropicBeta.MessageBatches2024_09_24] };
    ...
    public void CopyConstructor_Works()
    {
        ...
        TunnelListParams copied = new(parameters);
