...
public class TunnelArchiveParamsTest : TestBase
{
    [Fact]
    ...
    {
        var parameters = new TunnelArchiveParams { TunnelID = "tunnel_id" };
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri("https://api.anthropic.com/v1/tunnels/tunnel_id/archive?beta=true"),
                url
            )
        );
    }
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        TunnelArchiveParams parameters = new()
        {
            TunnelID = "tunnel_id",
            Betas = [AnthropicBeta.MessageBatches2024_09_24],
        };
    ...
    public void CopyConstructor_Works()
    {
        ...
        TunnelArchiveParams copied = new(parameters);
