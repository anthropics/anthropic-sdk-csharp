...
public class BetaWebhookVaultCredentialRefreshFailedEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaWebhookVaultCredentialRefreshFailedEventData
        {
            ID = "id",
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaWebhookVaultCredentialRefreshFailedEventData copied = new(model);
