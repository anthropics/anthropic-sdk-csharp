...
public class BetaWebhookVaultCreatedEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaWebhookVaultCreatedEventData
        {
            ID = "id",
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("vault.created");
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaWebhookVaultCreatedEventData copied = new(model);
