...
public class BetaWebhookVaultDeletedEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaWebhookVaultDeletedEventData
        {
            ID = "id",
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("vault.deleted");
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaWebhookVaultDeletedEventData copied = new(model);
