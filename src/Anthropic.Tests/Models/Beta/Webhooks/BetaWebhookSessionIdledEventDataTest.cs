...
public class BetaWebhookSessionIdledEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaWebhookSessionIdledEventData
        {
            ID = "id",
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("session.idled");
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaWebhookSessionIdledEventData copied = new(model);
