...
public class BetaWebhookSessionStatusIdledEventDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaWebhookSessionStatusIdledEventData
        {
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("session.status_idled");
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaWebhookSessionStatusIdledEventData>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaWebhookSessionStatusIdledEventData copied = new(model);
