...
public class BetaManagedAgentsWriteToolConfigParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaManagedAgentsWriteToolConfigParams
        {
            Enabled = true,
        ...
        BetaManagedAgentsWriteToolConfigParamsPermissionPolicy expectedPermissionPolicy =
            new BetaManagedAgentsAlwaysAllowPolicy(
                BetaManagedAgentsAlwaysAllowPolicyType.AlwaysAllow
            );
        ApiEnum<string, BetaManagedAgentsWriteToolConfigParamsType> expectedType =
            BetaManagedAgentsWriteToolConfigParamsType.Write;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaManagedAgentsWriteToolConfigParams>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaManagedAgentsWriteToolConfigParams copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class BetaManagedAgentsWriteToolConfigParamsPermissionPolicyTest : TestBase
{
    [Fact]
    ...
    public void BetaManagedAgentsAlwaysAllowSerializationRoundtripWorks()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<BetaManagedAgentsWriteToolConfigParamsPermissionPolicy>(
                element,
                ModelBase.SerializerOptions
            );
...
public class BetaManagedAgentsWriteToolConfigParamsTypeTest : TestBase
{
    [Theory]
    [InlineData(BetaManagedAgentsWriteToolConfigParamsType.Write)]
    public void Validation_Works(BetaManagedAgentsWriteToolConfigParamsType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BetaManagedAgentsWriteToolConfigParamsType> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(BetaManagedAgentsWriteToolConfigParamsType.Write)]
    public void SerializationRoundtrip_Works(BetaManagedAgentsWriteToolConfigParamsType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BetaManagedAgentsWriteToolConfigParamsType> value = rawValue;
