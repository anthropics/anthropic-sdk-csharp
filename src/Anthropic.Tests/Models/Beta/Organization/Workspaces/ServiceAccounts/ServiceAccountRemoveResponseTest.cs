...
public class ServiceAccountRemoveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ServiceAccountRemoveResponse
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ServiceAccountRemoveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ServiceAccountRemoveResponse copied = new(model);
