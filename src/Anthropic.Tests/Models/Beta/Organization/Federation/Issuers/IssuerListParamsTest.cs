...
public class IssuerListParamsTest : TestBase
{
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.anthropic.com/v1/organizations/federation_issuers?beta=true&include_archived=true&limit=1&page=page"
                ),
                url
            )
        );
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        IssuerListParams parameters = new() { Betas = [AnthropicBeta.MessageBatches2024_09_24] };
