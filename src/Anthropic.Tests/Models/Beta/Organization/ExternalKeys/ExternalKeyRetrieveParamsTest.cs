...
public class ExternalKeyRetrieveParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ExternalKeyRetrieveParams { ExternalKeyID = "external_key_id" };
    ...
    {
        ExternalKeyRetrieveParams parameters = new() { ExternalKeyID = "external_key_id" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ExternalKeyRetrieveParams copied = new(parameters);
