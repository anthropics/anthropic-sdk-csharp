...
public class BetaFileMetadataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaFileMetadata
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaFileMetadata>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaFileMetadata copied = new(model);
