...
public class BetaDeletedFileTest : TestBase
{
    [Fact]
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaDeletedFile>(
            json,
    ...
    {
        var model = new BetaDeletedFile { ID = "file_011CNha8iCJcU1wXNR6q4V8w" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaDeletedFile copied = new(model);
