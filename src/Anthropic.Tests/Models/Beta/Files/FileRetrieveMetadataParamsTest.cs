...
public class FileRetrieveMetadataParamsTest : TestBase
{
    ...
    {
        var parameters = new FileRetrieveMetadataParams
        {
            FileID = "file_id",
    ...
    public void Url_Works()
    {
        ...
        Assert.Equal(new Uri("https://api.anthropic.com/v1/files/file_id"), url);
    }
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        FileRetrieveMetadataParams parameters = new() { FileID = "file_id", Betas = ["string"] };
